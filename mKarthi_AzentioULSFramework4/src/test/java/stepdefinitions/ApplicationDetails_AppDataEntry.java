...
public class ApplicationDetails_AppDataEntry {
			...
			try {
				seleniumactions.getJavascriptHelper()
						.scrollIntoView(driver.findElement(By.xpath("//ion-label[contains(text(),'"
								+ applicationdetailsData.PrimaryProduct + "')]/following-sibling::ion-radio")));
	...
	public void select_the_value_in_sourcing_staff_field_of_application_details() throws Throwable {
		// seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,applicationentryobj.AppDataEntry_SourcingStaffField(),
		// 60, 2);applicationentryobj.AppDataEntry_SourcingStaffField().click();
	...
	public void enter_the_value_in_reference_code_field_of_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.AppDataEntry_ReferenceCodeField(), 60, 2);
		for (int i = 0; i < 50; i++) {
			try {
	...
	public void click_on_the_pencil_icon_of_first_record_in_application_details_view_list() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.apllicationDetails_PencilIconOfFirstRecord(), 60, 2);
	...
	public void update_the_value_in_primary_sub_product_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedPrimarySubProduct + "')]/following-sibling::ion-radio"))
						.click();
				break;
			} catch (Exception e) {
			}
	...
	public void update_the_value_in_declared_net_income_field_of_application_details() throws Throwable {
		...
		applicationentryobj.AppDataEntry_DeclaredNetIncomeField()
				.sendKeys(applicationdetailsData.UpdatedDeclaredNetIncome);
	}
	...
	public void update_the_value_in_special_promotion_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedSpecialPromotion + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void update_the_value_in_sourcing_channel_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedSourcingChannel + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void update_the_value_in_business_center_code_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedBusinessCenterCode + "')]/following-sibling::ion-radio"))
						.click();
				break;
			} catch (Exception e) {
			}
	...
	public void update_the_value_in_servicing_branch_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedServicingBranch + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void update_the_value_in_sourcing_office_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedSourcingOffice + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void update_the_value_in_reference_type_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ applicationdetailsData.UpdatedReferenceType + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
			}
		}
	...
	public void update_the_value_in_reference_code_field_of_application_details() throws Throwable {
		...
		for (int i = 0; i < 50; i++) {
			try {
				...
				applicationentryobj.AppDataEntry_ReferenceCodeField()
						.sendKeys(applicationdetailsData.UpdatedReferenceCode);
				break;
			} catch (Exception e) {
			}
		}
	...
	public void navigate_to_mail_box_of_application_details_and_search_the_app_data_entry_value() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_Inbox(), 30, 2);
		...
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetailsInboxView_SearchText(), 60, 2);
		applicationentryobj.ApplicationDetailsInboxView_SearchText().click();
		applicationentryobj.ApplicationDetailsInboxView_SearchText()
				.sendKeys(applicationdetailsData.SearchValueInInboxForAppDataEntry);
	...
	public void navigate_to_mail_box_of_application_details_and_search_the_offering_value() throws Throwable {
		...
		applicationentryobj.ApplicationDetailsInboxView_SearchText().click();
		applicationentryobj.ApplicationDetailsInboxView_SearchText()
				.sendKeys(applicationdetailsData.SearchValueInInboxForOffering);
	}
	...
	public void click_on_action_icon_of_first_record_of_application_detailsoffering_value() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetailsMailBoxActionButtonOfFirstRecord_Offering(), 30, 2);
	...
	public void click_on_action_icon_of_first_record_of_application_detailsapp_data_entry_value() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetailsMailBoxActionButtonOfFirstRecord_AppDataEntry(), 30, 2);
	...
	public void validate_the_save_successful_popup_of_application_details() throws Throwable {
		String Toast;
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetailsSaveSuccessfulPopup(), 60, 2);
	...
	public void select_application_details_in_the_offering_tab() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_ApplicationDetailsTabInOfferingScreen(), 30, 2);
		...
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath(
						"//ion-label[contains(text(),'" + applicationdetailsData.UpdatedPrimarySubProductForValidation
	...
	public void validate_the_field_is_required_popup_in_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.requiredFieldWarningPopup(), 60, 2);
...
//		System.out.println(declarednetincome);
	...
	public void validate_the_add_button_functionality() throws Throwable {
		...
		try {
			seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
					applicationentryobj.ApplicationDetailsAddIcon(), 10, 2);
	...
	public void validate_the_view_summary_functionality_in_app_data_entry_page() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.viewSummaryIconOfApplicationDetails(), 60, 2);
		seleniumactions.getJavascriptHelper().JSEClick(applicationentryobj.viewSummaryIconOfApplicationDetails());
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.viewSummaryPageOfApplicationDetails(), 60, 2);
	...
	public void enter_the_value_in_mobile_number_field_of_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_MobileNumberField(), 60, 2);
	...
	public void enter_the_value_in_date_of_birth_field_of_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_CalenderIcon(), 60, 2);
		applicationentryobj.ApplicationDetails_CalenderIcon().click();
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_CalenderIcon_TodayValue(), 60, 2);
	...
	public void enter_the_value_in_email_id_field_of_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_EmailIdField(), 60, 2);
	...
	public void enter_the_value_in_application_number() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_ApplicationNumberField(), 60, 2);
		applicationentryobj.ApplicationDetails_ApplicationNumberField().click();
		applicationentryobj.ApplicationDetails_ApplicationNumberField()
				.sendKeys(applicationdetailsData.ApplicationNumber);
	}
	...
	public void enter_the_value_in_customer_name_field_of_application_details() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				applicationentryobj.ApplicationDetails_CustomerNameField(), 60, 2);
