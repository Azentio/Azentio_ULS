...
public class AssetAutoMaster {
    ...
    public void user_click_add_icon_for_asset_auto_master() throws Throwable {
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,assetAutoMasterObj.addIcon(),180,2);
    ...
    public void user_search_asset_auto_records() throws Throwable {
    	...
    	for (int i = 0; i <20; i++) {
            ...
            assetAutoMasterObj.assetAutoInboxView_SearchText().sendKeys(testData.get("Inbox Search"));
    ...
    public void user_submit_asset_auto_record_in_maker() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, assetAutoMasterObj.assetAutoMaker_Submit(), 60, 2);
...
//******************************************checker approve *************************************************//
    ...
    public void user_click_on_return_icon_for_asset_auto_record() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,assetAutoMasterObj.Checker_Return(),30,2);
    ...
    public void user_click_on_reject_icon_for_asset_auto_record() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,assetAutoMasterObj.Checker_Reject(), 30,2);    	
    ...
    public void user_select_and_update_the_asset_type_in_asset_auto_master() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,assetAutoMasterObj.assetTypeUpdate(),60,2);
    ...
    public void user_verify_post_clicking_pdf_option_pdf_file_will_be_downloaded_for_asset_auto_master() throws Throwable {
    	testData = excelData.getTestdata("AT-AAM-T011-D1");
    	for (int i = 0; i < 20; i++) {
			try {
				assetAutoMasterObj.exportIcon().click();
				break;
		...
		for (File fileName : totalfiles) {
			i++;
			if (fileName.getName().equalsIgnoreCase(testData.get("PdfFileName"))) {
    ...
    public void user_verify_the_search_results_show_matched_data_for_asset_auto_master() throws Throwable {
		...
		assetAutoMasterObj.assetAutoViewSearchText().sendKeys(testData.get("SearchMatchData"));
    ...
    public void user_verify_the_search_results_shows_no_data_for_asset_auto_master() throws Throwable {
		...
		assetAutoMasterObj.assetAutoViewSearchText().sendKeys(testData.get("SearchUnmatchedData"));
		Thread.sleep(1000);
