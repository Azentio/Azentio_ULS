...
public class SubProductRetailMasterParameterStep extends BaseClass {
	...
	public void maker_login() throws Throwable {
		...
		// login
		// applicationLogin.loginUlsApplicationAsMaker("Username", "Password");
	...
	public void click_the_subproductretail_master() throws Throwable {
		...
		help.waitForElementToVisibleWithFluentWait(driver, subretail.subproductediticon(), 60, 5);
		subretail.subproductediticon().click();
	}
	...
	public void enter_the_required_sub_product_parameters_fields_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Loan Currency");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Indexation Currency");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Minimum Finance Amount");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Maximum Finance Amount");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min Tenor In Months");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Tenor In Months");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Repayment Type");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Flat/Reducing");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Int. Amortization Method");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Compute Installment on");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Inst. due date method");
		...
		morn.verifyGivenFieldisMandatoryOrNot("LPC grace period (days)");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Principal Repayment Frequency");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Interest Repayment Frequency");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Inst. Rounding Logic");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Loan Eligibility Calc.");
		...
		// 5);
		morn.verifyGivenFieldisMandatoryOrNot("Remarks");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Include Guarantor Inc.");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Due Period Required");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Coapplicants");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Guarantors");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Inst. Commence From");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Days In Year");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Multiple Disburs. Tranch Allowed");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Include Income Dedu. Debt");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Round Off");
		...
		// 60, 5);
		morn.verifyGivenFieldisMandatoryOrNot("RoundOff Value");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Offer Validity (Days)");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Appropriation Code");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Balloon Allowed");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Maximum Balloon Percentage");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min IRR");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max IRR");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Pre-owned Asset");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Discounting Factor Rounding");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Day Count Convention for BPI");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Interest Charging Starts From");
		...
		morn.verifyGivenFieldisMandatoryOrNot("BPI Recovery");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Installment Recovery Type");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Is Step-Up Allowed");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Rate Type");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Initiate Disc. Factor");
	...
	public void enter_the_required_preemi_fields_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Pre-EMI");
		...
		morn.verifyGivenFieldisMandatoryOrNot("No. Of Pre-EMI Installment");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("MI_RECOVERY_TO_BE_RENAMED_AS");
		...
		morn.verifyGivenFieldisMandatoryOrNot("BPI_REPAYMENT_TENURE_METHOD");
		...
		morn.verifyGivenFieldisMandatoryOrNot("BPI_RATE_METHOD");
		...
		morn.verifyGivenFieldisMandatoryOrNot("BPI_REPAYMENT_FREQUENCY");
		...
		morn.verifyGivenFieldisMandatoryOrNot("TDS_APPLICABLE");
		...
		morn.verifyGivenFieldisMandatoryOrNot("MORATORIUM_TENURE_TYPE");
	...
	public void click_the_action_edit_icon_in_checker() throws Throwable {
		...
		String xpath1 = "//span[contains(text(),'" + jsonRW.readReferancedata()
	...
	public void enter_the_required_bulk_payment_fields_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Bulk Payment");
		...
		morn.verifyGivenFieldisMandatoryOrNot("No of Bulk payment in a Year");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Bulk payment LockIn Period");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Bulk Payment Time Interval");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Immediate/Due date");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Bulk Payment Lock-In starts From");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min Bulk Payment Parameter");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min Bulk Payment Value");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Bulk Payment Parameter");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Bulk Payment Value");
		for (int i = 0; i < 20; i++) {
			try {
	...
	public void enter_the_required_foreclosure_fields_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Foreclosure Lockin");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Foreclosure Lock-In starts From");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min Rebate Parameter");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Min Rebate Value");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Rebate Parameter");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Rebate Value");
		for (int i = 0; i < 20; i++) {
			try {
	...
	public void enter_the_required_reschedulement_fields_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Resch Lockin");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Max Resch in a year");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Total Resch Allowed");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Reschedulement Lock-In starts From");
	...
	public void enter_the_required_moratoriumgrace_period_month_in_maker() throws Throwable {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Interest Holiday");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Principal Holiday");
		...
		morn.verifyGivenFieldisMandatoryOrNot("Interest Computed");
		...
		morn.verifyGivenFieldisMandatoryOrNot("MORATORIUM_START_MONTH_OR_INSTALLMENT");
		for (int i = 0; i < 20; i++) {
			try {
		...
		morn.verifyGivenFieldisMandatoryOrNot("Recomputation of Profit");
