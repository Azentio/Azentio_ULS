...
public class KULS_CustomerEntityLayout_FacilityDetails extends BaseClass {
    ...
    public void user_click_the_submit_button_in_customer_entity_layout_facility_details() throws Throwable {
    	...
    	help.waitForElementToVisibleWithFluentWait(driver, Transaction.ApproveButton(), 60, 5);
    	Transaction.ApproveButton().click();
    ...
    public void user_click_the_application_info_tab_in_customer_entity_layout_facility_details() throws Throwable {
