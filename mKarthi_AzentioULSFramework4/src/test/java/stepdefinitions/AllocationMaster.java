...
public void modify_the_allocation_based_on_in_allocation_detail() throws Throwable {
	...
	String xpath ="//ion-label[text()=' "+allocationMasterData.AllocationBasedOnModification+" ']//following-sibling::ion-radio";
	for (int i = 0; i <200; i++) {
		try {
			driver.findElement(By.xpath(xpath)).click();
			break;
...
public void modify_the_order_by_value_in_allocation_details() throws Throwable {
	...
	String xpath ="//ion-label[text()=' "+allocationMasterData.OrderByModification+" ']//following-sibling::ion-radio";
	for (int i = 0; i <200; i++) {
		try {
			driver.findElement(By.xpath(xpath)).click();
			break;
...
public void modify_the_leval_no_in_allocation_details() throws Throwable {
	...
	for (int i = 0; i <30; i++) {
		try {
			...
			allocationMstObj.allocationDetail_LevelNo().sendKeys(allocationMasterData.LevelNoModification);
			break;
		} catch (Exception e) {
