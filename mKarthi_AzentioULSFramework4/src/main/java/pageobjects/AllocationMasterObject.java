...
public class AllocationMasterObject {
	...
	//****************Checker Stage*****************************//
		 ...
		 @FindBy(xpath="//span[text()='Export']/following-sibling::div/span")
			...
			@FindBy(xpath="//ion-label[text()=' Allocation Based On ']//following-sibling::ion-select")
			private WebElement allocationDetail_AllocationBasedOn_Dropdown_Modification1;
			public WebElement allocationDetail_AllocationBasedOn_Dropdown_Modification() {
				return allocationDetail_AllocationBasedOn_Dropdown_Modification1;
			}
			...
			@FindBy(xpath="//ion-label[text()=' Order By ']//following-sibling::ion-select")
			private WebElement allocationDetail_OrderBy_Dropdown_Modification1;
			public WebElement allocationDetail_OrderBy_Dropdown_Modification() {
				return allocationDetail_OrderBy_Dropdown_Modification1;
			}
			@FindBy(xpath="//button[@ng-reflect-text='Save']")
			...
			@FindBy(xpath="(//button[@ng-reflect-text='Update'])[1]")
			private WebElement allocationDetail_Updation1;
			public WebElement allocationDetail_Updation() {
				return allocationDetail_Updation1;
			}
			...
			@FindBy(xpath="//ion-title[text()=' Allocation Details ']//ancestor::ion-card//tr[1]//button[1]")
			private WebElement AllocationDetails_EditIcon1;
			public WebElement AllocationDetails_EditIcon() {
				return AllocationDetails_EditIcon1;
			}
			}
