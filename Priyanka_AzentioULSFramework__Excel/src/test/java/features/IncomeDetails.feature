...
And user update the data set ID for Income details1 
...
Then click on inbox
Then click on inbox search icon 
And user update the data set ID for Income details2 
Then search Income Details record
And maker user open the record from inbox
Then click on Customer Financials Segment button
Then click on Customer Financials Record Edit button
...
Then click on inbox
Then click on inbox search icon 
And user update the data set ID for Income details3
Then search Income Details record
And maker user open the record from inbox
Then click on Customer Financials Segment button
Then click on Customer Financials Record Edit button
...
Then click on inbox
Then click on inbox search icon
And user update the data set ID for Income details4 
Then search Income Details record
And maker user open the record from inbox
Then click on Customer Financials Segment button
Then click on Customer Financials Record Edit button
...
Then click on inbox search icon 
Then search Income Details record
And user update the data set ID for Income details5
And maker user open the record from inbox
Then click on Customer Financials Segment button
Then click on Customer Financials Record Edit button
