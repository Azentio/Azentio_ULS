...
public class IncentiveMasterObj {
	...
	@FindBy(xpath = "//ion-label[contains(text(),'Config Manager')]/../ion-icon[1]")
	...
	// CheckBox_Button
	@FindBy(xpath = "//ion-label[contains(text(),'Incentive master')]/../ion-buttons[1]/ion-button[2]")
//	@FindBy(xpath = "//ion-accordion[1]/ion-list[1]/ion-item[35]/ion-buttons[1]/ion-button[2]")
	...
	private WebElement IncentiveMaster_SelectLabel;

	public WebElement IncentiveMaster_SelectLabel() {
		return IncentiveMaster_SelectLabel;
	}
	...
	private WebElement IncentiveMaster_SaveConfirmationMessage;

	public WebElement IncentiveMaster_SaveConfirmationMessage() {
		return IncentiveMaster_SaveConfirmationMessage;
	}// div[@id='toast-container']//div[@role='alert']

	// save success message close button
	@FindBy(xpath = "//body/div/div/div/button")
	private WebElement IncentiveMaster_SaveConfirmationMessageCloseButton;

	public WebElement IncentiveMaster_SaveConfirmationMessageCloseButton() {
		return IncentiveMaster_SaveConfirmationMessageCloseButton;
	}
	...
	//ReferanceId
		...
		private WebElement IncentiveMaster_ReferanceId;
		public WebElement IncentiveMaster_ReferanceId() {
			return IncentiveMaster_ReferanceId;
		}

		//Action //tbody/tr[1]/td[1]/span[1]/button[1]/span[1]
		@FindBy(xpath = "//tbody/tr[1]/td[1]/button[1]")
		private WebElement IncentiveMaster_Action;
		public WebElement IncentiveMaster_Action() {
			return IncentiveMaster_Action;
		}
		
		//MakerSubmit
		@FindBy(xpath = "//button/span[contains(text(),'Submit')]")
		private WebElement IncentiveMaster_Submit;
		public WebElement IncentiveMaster_Submit() {
			return IncentiveMaster_Submit;
		}
		
		//SubmitRemark
		@FindBy(xpath = "//ion-label[contains(text(),'ok')]")
		private WebElement IncentiveMaster_SubmitRemark;
		public WebElement IncentiveMaster_SubmitRemark() {
			return IncentiveMaster_SubmitRemark;
		}

		//FinalSubmit
		@FindBy(xpath = "(//span[contains(text(),'Submit')])[2]")
		private WebElement IncentiveMaster_FinalSubmit;
		public WebElement IncentiveMaster_FinalSubmit() {
				return IncentiveMaster_FinalSubmit;
		}
		
		@FindBy(xpath = "//div[@id='toast-container']/div[1]")
		private WebElement IncentiveMaster_Checker_Id;

		public WebElement IncentiveMaster_Checker_Id() {
			return IncentiveMaster_Checker_Id;
		}
