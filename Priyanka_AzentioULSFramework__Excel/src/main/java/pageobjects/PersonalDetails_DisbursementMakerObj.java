...
public class PersonalDetails_DisbursementMakerObj {
	...
	private WebElement PDDM_Corporate;

	public WebElement PDDM_Corporate() {
		return PDDM_Corporate;
	}

	// LOS
	@FindBy(xpath = "//ion-label[contains(text(),'LOS')]/..//ion-radio[1]")
	private WebElement PDDM_LOS;

	public WebElement PDDM_LOS() {
		return PDDM_LOS;
	}
	// search input fields
