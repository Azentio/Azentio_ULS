...
//	@AT_UNW_002
	...
	public void user_click_the_module_name_dropdown_in_uls_application() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("moduleNameDropdown")));
		
		for (int i = 0; i <= 500; i++) {
			try {
		//		javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("moduleNameDropdown")).click();
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("moduleNameDropdown")).click();
				break;
			} catch (Exception e) {
				if (i == 500) {
...
//                    if (moduleName.equalsIgnoreCase("LOS")) {
	...
	//	waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("mailBox")));
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("mailBox")));
		for (int i = 0; i <= 500; i++) {
			try {
		//		javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("mailBox")).click();
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("mailBox")).click();
				break;
			} catch (Exception e) {
				if (i == 500) {
					Assert.fail(e.getMessage());
	...
	//	waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("mailInboxSearchBtn")));
		waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("mailInboxSearchBtn")));
		for (int i = 0; i <= 500; i++) {
			try {
	//			javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("mailInboxSearchBtn")).click();
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("mailInboxSearchBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 500) {
					Assert.fail(e.getMessage());
	...
	//	waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDebtJsPaths.getElement("inboxSearchInput")));
		...
		for (int i = 0; i <= 2000; i++) {
			try {
		//		 javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("inboxSearchInput")).sendKeys("3619");
				 javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("inboxSearchInput")).sendKeys("3901");
		//		 javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("inboxSearchInput")).sendKeys(testData.get("Ref No"));
	...
	public void user_click_the_entitle_button_under_inbox() throws Throwable {
		for (int i = 0; i <= 1000; i++) {
			try {
		        waitHelper.waitForElementwithFluentwait(driver, javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("inboxEntitleBtn")));
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("inboxEntitleBtn")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_verify_the_popup_post_clicking_save_button() {
		javascriptHelper.scrollToElemet(javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("customerDetails_SaveBtn")));
		//javascriptHelper.scrollIntoView(javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("customerDetails_SaveBtn")));
		String popUp=null;
		for (int i = 0; i <= 1000; i++) {
			try {
				popUp =javascriptHelper.executeScript("return "+customerDetailsJsPaths.getElement("postClickSavePopup")).toString();
	...
	public void user_click_on_the_hamburger_menu() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("hamburgerMenu")).click();
	...
	public void user_click_on_the_transactions_module() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("hB_Transaction")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	public void user_click_on_the_appication_manager_option() {
		for (int i = 0; i <= 1000; i++) {
			try {
				javascriptHelper.executeScriptWithWebElement(customerDetailsJsPaths.getElement("hB_ApplicationManager")).click();
				break;
			} catch (Exception e) {
				if (i == 1000) {
					Assert.fail(e.getMessage());
	...
	@And("user click on the customer details module")
	public void user_click_on_the_customer_details_module() {
