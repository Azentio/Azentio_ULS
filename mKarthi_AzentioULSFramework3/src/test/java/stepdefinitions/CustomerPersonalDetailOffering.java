...
public class CustomerPersonalDetailOffering {
	...
	public void enter_the_reference_id_of_the_personal_detail_offering_record() throws Throwable {
		...
		customerPersonalDetailOfferingObj.customerPersonalDetailOffering_SearchInboxInputField().sendKeys(customerPersonalDetailOfferingTestDataType.ReferenceID);
	}
