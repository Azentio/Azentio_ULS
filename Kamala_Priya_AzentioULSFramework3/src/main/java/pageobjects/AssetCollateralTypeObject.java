...
public class AssetCollateralTypeObject {
		WebDriver driver;
		 ...
		 @FindBy(xpath="//ion-label[text()='Collateral type']//parent::ion-label//following-sibling::ion-buttons/ion-button[2]")
		 ...
		 @FindBy(xpath="//ion-label[text()='Collateral type']//parent::ion-label//following-sibling::ion-buttons/ion-button[1]")
