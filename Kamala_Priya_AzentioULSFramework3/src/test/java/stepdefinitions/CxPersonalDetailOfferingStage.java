...
public class CxPersonalDetailOfferingStage extends BaseClass {
    ...
    public void search_the_record_in_customer_details_at_offering_stage() throws Throwable {
		waithelper.waitForElementToVisibleWithFluentWait(driver, PersonalOffering.SearchButton(), 60, 2);
		PersonalOffering.SearchButton().click();
