...
public class OwnershipDetails extends BaseClass {
	...
	// OwnershipDetailsTestDataType OwnershipDetailsTestDataType =
	// jsonReader.getOwnershipDetailsByName("Maker");
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00075\\Downloads\\UlsTestDataDesign.xlsx",
			"OwnershipdetailsTestdata", "Data Set ID");
		...
		while (true) {
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_SearchInputField(), 10, 1);
				OwnershipDetailsObj.OwnershipDetails_SearchInputField().click();
				OwnershipDetailsObj.OwnershipDetails_SearchInputField().sendKeys(testdata.get("StageCode"));
				break;
			} catch (Exception E) {
			}
		}
	...
	public void naviagte_to_the_ownership_details_segment_button() {
		while (true) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_OwnershipSegmentButton(), 1, 1);
				OwnershipDetailsObj.OwnershipDetails_OwnershipSegmentButton().click();
				break;
			} catch (Exception e) {
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_NextButton(), 2, 1);
	...
	public void verify_the_field_owner_power_of_attorney_details() {
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				OwnershipDetailsObj.OwnershipDetails_OwnerPowerOfAttorneyDetails(), 5, 1);
		OwnershipDetailsObj.OwnershipDetails_OwnerPowerOfAttorneyDetails().click();

		waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_OwnerDropdown(),
				5, 1);
	...
	public void verify_the_field_name_of_ownership_details() throws InterruptedException {
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_Name(), 5,
						1);
				// findFieldisMandatoryorNot.verifyGivenFieldisMandatoryOrNot("Name");
				...
				// waithelper.waitForElementToVisibleWithFluentWait(driver,
				// OwnershipDetailsObj.OwnershipDetails_OwnerPowerOfAttorneyDetails(), 10, 1);
	...
	public void verify_the_field_id_type_is_pan_card() {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_PanCardDropdown(),
				5, 1);
	...
	public void verify_the_field_id_number_when_id_type_is_pan_card() throws InterruptedException {
		waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_IdNumber(), 10,
				1);
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_IdNumber(), 5, 1);
	...
	public void verify_the_field_id_type_is_aadhar_card() {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver,
				OwnershipDetailsObj.OwnershipDetails_AadharCardDropdown(), 5, 1);
	...
	public void verify_the_field_id_number_when_id_type_is_aadhar_card() {
		for (int i = 1; i < 10; i++) {
			...
			try {
				...
				OwnershipDetailsObj.OwnershipDetails_IdNumber()
						.sendKeys(testdata.get("IdNumberAadharCard"));
				OwnershipDetailsObj.OwnershipDetails_IdNumber().sendKeys(Keys.ENTER);
				break;
			} catch (Exception E) {
			}
	...
	public void verify_the_field_issue_date_of_ownership_details() {
		while (true) {
			try {
				...
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_IssueDate(), 10, 1);
		...
		while (true) {
			try {
				...
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_TodayDate(), 10, 1);
	...
	public void verify_the_field_issue_place_of_ownership_details() {
		waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_IssuePlace(), 10,
				1);
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver,
						OwnershipDetailsObj.OwnershipDetails_IssuePlace(), 5, 1);
	...
	public void verify_the_field_city_of_ownership_details() {
		...
		waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_CityDropdown(), 5,
				1);
	...
	public void verify_the_field_mobile_of_ownership_details() {
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_Mobile(),
						5, 1);
	...
	public void verify_the_field_mobile2_of_ownership_details() {
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_Mobile2(),
						5, 1);
	...
	public void verify_the_field_fax_of_ownership_details() {
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_Fax(), 5,
						1);
	...
	public void verify_the_field_email_of_ownership_details() {
		...
		for (int i = 1; i < 10; i++) {
			...
			try {
				waithelper.waitForElementToVisibleWithFluentWait(driver, OwnershipDetailsObj.OwnershipDetails_Email(),
						5, 1);
    ...
    public void user_update_the_Excelsheet_Testdata_for_validation() throws Throwable{
    	testdata=exceldata.getTestdata("OW_002_D1");
    }
