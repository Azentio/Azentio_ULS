...
public class PersonalDetails_AppDataEntry extends BaseClass{
	...
	ExcelData exceldata = new ExcelData("C:\\Users\\inindc00075\\Downloads\\UlsTestDataDesign.xlsx", "Personal Details_App Data", "Data Set ID") ;
    ...
    public void user_verify_the_customer_type_field() throws Throwable {
        ...
        testData=exceldata.getTestdata("AT_PDE_001_D1");
    }
...
//    	AppDataEntry.calendarFirstYear().click();
    ...
    public void user_verify_the_back_button_list_view() throws Throwable {
     waitHelper.waitForElementToVisibleWithFluentWait(driver, AppDataEntry.customerPersonalDetails_BackButton(), 60, 5);
     AppDataEntry.customerPersonalDetails_BackButton().click();
    }
    ...
    public void user_verify_the_cif_id_list_view() throws Throwable { 		
        ...
        try {
        	...
        	testData=exceldata.getTestdata("AT_PDE_004_D1");
    }
