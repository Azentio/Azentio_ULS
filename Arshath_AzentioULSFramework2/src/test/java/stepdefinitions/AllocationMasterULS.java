...
public class AllocationMasterULS {
	...
	public void user_click_and_update_description() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-007_D1");
		allocationMasterObj.AllocationMaster_DescriptionTextBox().sendKeys(testData.get("Description"));
	}
	...
	public void user_click_and_update_allocation_code() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-007_D1");
		allocationMasterObj.AllocationMaster_AllocationCodeTextBox().sendKeys(testData.get("Allocation code"));
	}
	...
	public void user_search_allocation_master() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-007_D1");
		allocationMasterObj.InboxView_SearchText().sendKeys(testData.get("Search"));
	}
	...
	public void user_store_reference_number_and_click_the_first_record_in_allocation_master_inbox_view()
		...
		// 2);
		exceldata.updateTestData("AT-ALM-007_D1", "Reference ID", reference);
    ...
    public void user_capture_checker_id_for_checker_submit() throws Throwable {
       ...
       // json.addData(popupID);
        exceldata.updateTestData("AT-ALM-007_D1", "Checker id", popupID);
