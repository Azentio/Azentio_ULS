...
public class ULS_DrawdownDetailsObj {
	...
	private WebElement uls_DrawdownDetails_SearchIcon;
	public WebElement uls_DrawdownDetails_SearchIcon() 
	{
		return uls_DrawdownDetails_SearchIcon;
	}
	@FindBy(xpath="//span[text()=' Inbox ']//parent::div//child::span[2]/input")
	private WebElement uls_DrawdownDetails_SearchInputField;
	public WebElement uls_DrawdownDetails_SearchInputField() 
	{
		return uls_DrawdownDetails_SearchInputField;
	}
