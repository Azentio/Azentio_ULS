...
public class CovenantMasterObj {
	...
	private WebElement covenantMaster_ModuleName;
	
	public WebElement covenantMaster_ModuleName() {
		return covenantMaster_ModuleName;
	}
...
//	@FindBy(xpath = "(//li[3]//ion-icon[1])[1]")
	...
	@FindBy(xpath = "//ion-title[contains(text(),'List Of Covenant Master')]")
	private WebElement covenantMaster_ListOfCovenantMasterTitle;

	public WebElement covenantMaster_ListOfCovenantMasterTitle() {
...
//	description editable
	...
	private WebElement covenantMaster_DescriptionEditable;

	public WebElement covenantMaster_DescriptionEditable() {
		return covenantMaster_DescriptionEditable;
	}
	
//	description
	@FindBy(xpath = "//ion-label[text()=' Description ']/following::ion-input[1]/input")
...
//	}
	...
	private WebElement covenantMaster_SearchInbox;

	public WebElement covenantMaster_SearchInbox() {
		return covenantMaster_SearchInbox;
	}

	// search inbox input fields
	@FindBy(xpath = "//p-table/div/div/div/span/input")
	private WebElement covenantMaster_SearchInboxInputField;

	public WebElement covenantMaster_SearchInboxInputField() {
		return covenantMaster_SearchInboxInputField;
	}

	// SearchInboxCloseButton
	@FindBy(xpath = "//p-table/div/div/div/span/i")
	private WebElement covenantMaster_SearchInboxCloseButton;

	public WebElement covenantMaster_SearchInboxCloseButton() {
		return covenantMaster_SearchInboxCloseButton;
	}
...
//	@FindBy(xpath = "//tbody/tr[1]/td[2]/span[1]")
	...
	@FindBy(xpath = "//td[contains(text(),'COVENANT_MST')]/../../tr[1]/td[1]/button[1]/span[1]")
	private WebElement covenantMaster_Checker_FirstRecordEntitleButton;
	
	public WebElement covenantMaster_Checker_FirstRecordEntitleButton() {
		return covenantMaster_Checker_FirstRecordEntitleButton;
	}
...
//	@FindBy(xpath = "//button[@ng-reflect-text='View Summary']")
	@FindBy(xpath = "//kub-workflow-decision[1]/span[1]/button[4]/span[1]")
