...
//	@FindBy(xpath = "//ion-col[6]/digital-text-box[1]/ion-item[1]/ion-input[1]/input[1]")
	@FindBy(xpath = "//ion-label[contains(text(),' Address Line 1 ')]/following-sibling::ion-input/input")
	...
	@FindBy(xpath = "//ion-label[contains(text(),' Address Line 2 ')]/following-sibling::ion-input/input")
...
//	@FindBy(xpath = "//ion-col[11]/digital-select-layout[1]/ion-item[1]/ion-select")
	@FindBy(xpath = "//ion-label[contains(text(),' Neighbourhood/District Name ')]/following-sibling::ion-select")
	...
	// City id   field
	@FindBy(xpath = "//ion-label[contains(text(),' City ')]/../ion-input/input")
...
//	@FindBy(xpath = "//ion-col[19]/digital-text-box[1]/ion-item[1]/ion-input[1]/input[1]")
	@FindBy(xpath = "//ion-label[contains(text(),' Land Mark ')]/following-sibling::ion-input/input")
...
//	@FindBy(xpath = "//ion-col[21]/digital-text-box[1]/ion-item[1]/ion-input[1]/input[1]")
	@FindBy(xpath = "//ion-label[contains(text(),' Landlord Name ')]/following-sibling::ion-input/input")
...
//	@FindBy(xpath = "//ion-col[22]/digital-text-box[1]/ion-item[1]/ion-input[1]/input[1]")
	@FindBy(xpath = "//ion-label[contains(text(),' Landlord Mobile Number ')]/following-sibling::ion-input/input")
...
//	@FindBy(xpath = "//ion-col[23]/digital-text-box[1]/ion-item[1]/ion-input[1]/input[1]")
	@FindBy(xpath = "//ion-label[contains(text(),' Rent Amount ')]/following-sibling::ion-input/input")
