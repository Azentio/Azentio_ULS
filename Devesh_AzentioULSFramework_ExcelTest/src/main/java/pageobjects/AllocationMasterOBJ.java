...
public class AllocationMasterOBJ {
	...
	private WebElement allocationMaster_Configuration;

	public WebElement allocationMaster_Configuration() {
		return allocationMaster_Configuration;
	}
	
	@FindBy(xpath = "//ion-col/div/ion-button")
	private WebElement allocationMaster_MenuToggle;
	
	public WebElement allocationMaster_MenuToggle() {
		return allocationMaster_MenuToggle;
	}
	...
	private WebElement allocationMaster_RequiredField;

	public WebElement allocationMaster_RequiredField() {
		return allocationMaster_RequiredField;
	}
