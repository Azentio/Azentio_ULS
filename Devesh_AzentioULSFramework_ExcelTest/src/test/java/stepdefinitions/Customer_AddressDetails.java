	    ...
	    public void search_customer_address_details_record()  {
		 while(true)
	    	...
	    	try{
	    	    ...
	    	    customer_AddressDetailsObj.Customer_AddressDetails_SearchInputField().sendKeys(testData.get("Application id"));
	    	    break;
	    	}catch(Exception E){}
	    	}  
	    }
...
//	    	javaScriptHelper.scrollToElemet(customer_AddressDetailsObj.Customer_AddressDetails_ResidentialOrOccupancyStatusDropdown());
	    ...
	    public void enter_address_line1() {
	    	...
	    	customer_AddressDetailsObj.Customer_AddressDetails_AddressLine1Field().sendKeys(testData.get("Address Line1"));
	    ...
	    public void enter_address_line2() {
	    	...
	    	customer_AddressDetailsObj.Customer_AddressDetails_AddressLine2Field().sendKeys(testData.get("Address Line2"));
...
//		    	javaScriptHelper.scrollToElemet(customer_AddressDetailsObj.Customer_AddressDetails_ResidentialOrOccupancyStatusDropdown());
	    ...
	    public void enter_neighbourhood_district_name() {
	    	...
	    	customer_AddressDetailsObj.Customer_AddressDetails_NeighbourhoodDistrictNameField().sendKeys(testData.get("District Name"));
	    ...
	    public void enter_zip_code() {
	    	...
	    	customer_AddressDetailsObj.Customer_AddressDetails_ZipCodeField().sendKeys(testData.get("Zip Code"));
	    ...
	    public void enter_mobile_number_primary() {
	    	...
	    	customer_AddressDetailsObj.Customer_AddressDetails_MobileNumberPrimaryField().sendKeys(testData.get("Mobile Number Primary"));
