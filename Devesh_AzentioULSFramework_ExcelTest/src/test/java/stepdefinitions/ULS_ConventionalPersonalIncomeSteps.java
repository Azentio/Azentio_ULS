...
public class ULS_ConventionalPersonalIncomeSteps extends BaseClass {
	...
	ExcelData excelData = new ExcelData("C:\\Users\\inindc00091\\eclipse-workspace\\Devesh_AzentioULSFramework_ExcelTest\\Test-data\\TestDataDesignSample.xlsx","Conv_ReferenceScreenTestData","Data Set ID");
	...
	@And("^search for app data entry record for conventional personal details$")
	public void search_for_app_data_entry_record_for_conventional_personal_details() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, conventionaIncomeDetailsObj.ulsNotificationSearchTextBox(), 20,
				1);
		clicksAndActionsHelper.moveToElement(conventionaIncomeDetailsObj.ulsNotificationSearchTextBox());
		clicksAndActionsHelper.clickUsingActionClass(conventionaIncomeDetailsObj.ulsNotificationSearchTextBox(),
				conventionaIncomeDetailsObj.ulsNotificationSearchTextBox());
		conventionaIncomeDetailsObj.ulsNotificationSearchTextBox().sendKeys(testData.get("Stage Code"));
		Thread.sleep(400);
	}

	@And("^select the app data entry first record for conventional personal details$")
	public void select_the_app_data_entry_first_record_for_conventional_personal_details() throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, conventionaIncomeDetailsObj.ulsNotificationRecordStageCode(),
//				10, 1);
//		for (int i = 0; i <= 10; i++) {
//			try {
//				if (conventionaIncomeDetailsObj.ulsNotificationRecordStageCode().getText()
//						.equals(testData.get("Stage Code"))) {
//					System.out.println("Stage Code " + testData.get("Stage Code") + " found successfully");
//					try {
						waitHelper.waitForElementToVisibleWithFluentWait(driver,
								conventionaIncomeDetailsObj.ulsMailBoxFirstRecord(), 20, 1);
						conventionaIncomeDetailsObj.ulsMailBoxFirstRecord().click();
//						break;
//					} catch (Exception e) {
//
//					}
//				} else {
//					if (i == 10) {
//						Assert.fail(testData.get("Stage Code") + " is not available ");
//					}
//				}
//			}
//
...
//		}
	...
	public void get_the_data_from_the_application_screen_of_salutation_name_mobile_number_and_years_of_known_and_status()
		...
		javascriptHelper.scrollIntoView(conventionaIncomeDetailsObj.conventionalIncomeDetailsStatusToggle());
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
...
//Assert.assertTrue(downlodedPDFFile.contains("CustomerReferenceDataFile"));
	...
	public void verify_xls_field_is_downloaded_in_the_download_section() throws Throwable {
	 ...
	 @Then("^select data set ID for conventional personal details testcase001$")
	    public void select_data_set_id_for_conventional_personal_details_testcase001() throws Throwable {
		 dataSetID = "AT_CLID_001_D1";
