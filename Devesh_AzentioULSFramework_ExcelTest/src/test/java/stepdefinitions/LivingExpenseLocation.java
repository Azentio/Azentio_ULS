...
public class LivingExpenseLocation {
	...
	ExcelData excelData = new ExcelData("C:\\Users\\inindc00091\\eclipse-workspace\\Devesh_AzentioULSFramework_ExcelTest\\Test-data\\TestDataDesignSample.xlsx","LivingExpenseTestData","Data Set ID");
    ...
    public void select_the_record_of_living_expenses_location_to_approve() throws Throwable {
		...
		livingExpenseObj.livingExpense_Checker_SearchInboxInputField().sendKeys(testData.get("Reference ID"));
...
//		xpath - //span[contains(text(),'5550')]/../../td[1]/button
    ...
    public void enter_remark_for_approve_the_living_expenses_location_record() throws Throwable {
    	...
    	livingExpenseObj.livingExpense_Checker_CheckerApproveRemark().sendKeys(testData.get("Checker Approve Remark"));
...
//		waithelper.waitForElementwithFluentwait(driver, livingExpenseObj.livingExpenseConfigManager());
//		livingExpenseObj.livingExpenseConfigManager().click();
//    }
    ...
    public void verify_all_the_captured_data_of_living_expenses_location_record_from_makers_side_should_be_saved_and_stored_in_the_system() throws Throwable {
		...
		livingExpenseObj.livingExpense_SearchInputField().sendKeys(testData.get("Approved Record"));
		String beforexpath = "//span[contains(text(),'"; 
    	String afterxpath = "')]"; 
    	Thread.sleep(1000);
...
//		xpath - //span[contains(text(),'5550')]/../../td[1]/button
    ...
    public void enter_remark_for_reject_the_living_expenses_location_record() throws Throwable {
    	...
    	livingExpenseObj.livingExpense_Checker_CheckerRejectRemark().sendKeys(testData.get("Checker Submit Remark"));
...
//		xpath - //span[contains(text(),'5550')]/../../td[1]/button
    ...
    public void enter_remark_for_return_the_living_expenses_location_record() throws Throwable {
    	...
    	livingExpenseObj.livingExpense_Checker_CheckerReturnRemark().sendKeys(testData.get("Approved Record"));
    ...
    public void verify_all_the_captured_data_of_living_expenses_location_record_from_makers_side_should_be_returned_and_stored_in_the_system() throws Throwable {
		...
		String beforexpath = "//span[contains(text(),'"; 
    	String afterxpath = "')]"; 
    	boolean res = driver.findElement(By.xpath(beforexpath +testData.get("Approved record")+ afterxpath)).isDisplayed();
    	Assert.assertTrue(res);
   
    }
    
    @Then("^select data set ID for living expense testcase031$")
    public void select_data_set_id_for_living_expense_testcase031() throws Throwable {
    	dataSetID = "AT_LE_31_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for living expense testcase032$")
    public void select_data_set_id_for_living_expense_testcase032() throws Throwable {
    	dataSetID = "AT_LE_32_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for living expense testcase033$")
    public void select_data_set_id_for_living_expense_testcase033() throws Throwable {
    	dataSetID = "AT_LE_33_D1";
        testData = excelData.getTestdata(dataSetID);
    }
