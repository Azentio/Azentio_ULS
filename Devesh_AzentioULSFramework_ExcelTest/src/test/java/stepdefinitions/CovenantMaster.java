...
//		radioButtonHelper.radioButton("General");
		...
		waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
		boolean status = covenantMasterObj.covenantMaster_CovenantType().getAttribute("ng-reflect-interface").equalsIgnoreCase("popover");
		Assert.assertTrue(status,"Not a dropdown list");
		boolean status1 = covenantMasterObj.covenantMaster_CovenantType().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertTrue(status1,"Dropdown is not editable");
	...
	public void verify_the_description_field_should_be_mandatory_and_editable_textbox() throws Throwable {
		...
		boolean status = covenantMasterObj.covenantMaster_DescriptionEditable().getAttribute("ng-reflect-readonly").equalsIgnoreCase("false");
		Assert.assertTrue(status,"Not an editable textbox");
	}
...
//		covenantMasterObj.covenantMaster_EditableToggle().click();
		boolean status = covenantMasterObj.covenantMaster_EditableToggle().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertTrue(status,"Not an editable checkbox");
	}
...
//		covenantMasterObj.covenantMaster_ActionableToggle().click();
		boolean status = covenantMasterObj.covenantMaster_ActionableToggle().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertTrue(status,"Not an editable checkbox");
	}
...
//		covenantMasterObj.covenantMaster_WaiverAllowedToggle().click();
		boolean status = covenantMasterObj.covenantMaster_WaiverAllowedToggle().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertTrue(status,"Not editable checkbox");
	...
	////////////////////////////////////////////////////////////////////////////////
	 ...
	 @Then("^Fill all valid fields in the covenant master screen for approve the record$")
	    public void fill_all_valid_fields_in_the_covenant_master_screen_for_approve_the_record() throws Throwable {
		 waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
		 covenantMasterObj.covenantMaster_CovenantType().click();
//		 testData = excelData.getTestdata("AT_CM_02_D1");
		 radioButtonHelper.radioButton(testData.get("Covenant Type"));
		 ...
		 clicksAndActionsHelper.doubleClick(covenantMasterObj.covenantMaster_Description());
			while (true) {
				try {
					...
					covenantMasterObj.covenantMaster_Description().sendKeys(testData.get("Description"));
					break;
	    ...
	    public void verify_system_should_display_the_confirmation_message_post_clicking_on_save_button() throws Throwable {
	    	...
	    	String msg = covenantMasterObj.covenantMaster_SaveConfirmationMessage().getText();
...
//	    	covenantMasterObj.covenantMaster_NewSavedRecord().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInbox());
	    	covenantMasterObj.covenantMaster_SearchInbox().click();
			waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInboxInputField());
			covenantMasterObj.covenantMaster_SearchInboxInputField().sendKeys(testData.get("Reference ID"));
	    ...
	    public void click_on_submit_button_to_submit_the_record_of_covenant_master() throws Throwable {
	    	...
	    	covenantMasterObj.covenantMaster_MakerSubmitRemark().sendKeys(testData.get("Maker Submit Remark"));
...
//	    Checker Approve--------------------------------
	    ...
	    public void select_the_record_of_covenant_master_to_approve() throws Throwable {
			...
			covenantMasterObj.covenantMaster_Checker_SearchInboxInputField().sendKeys(testData.get("Reference ID"));
...
//			xpath - //span[contains(text(),'5550')]/../../td[1]/button
	    ...
	    public void select_the_record_of_covenant_master_to_view_workflow() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Checker_SearchInbox());
	    	covenantMasterObj.covenantMaster_Checker_SearchInbox().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Checker_SearchInboxInputField());
	    	covenantMasterObj.covenantMaster_Checker_SearchInboxInputField().sendKeys(testData.get("Approved Record"));
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Checker_FirstRecordEntitleButton());
	    	covenantMasterObj.covenantMaster_Checker_FirstRecordEntitleButton().click();
	    }
	    ...
	    public void enter_remark_for_approve_the_record_of_covenant_master() throws Throwable {
	    	...
	    	covenantMasterObj.covenantMaster_Checker_CheckerApproveRemark().sendKeys(testData.get("Checker Submit Remark"));
	    ...
	    public void verify_record_should_get_approved_and_display_in_the_system_under_approved_list_view() throws Throwable {
			...
			covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Description"));
			String beforexpath = "//span[contains(text(),'"; 
	    	String afterxpath = "')]"; 
	    	Thread.sleep(1000);
	    	boolean description = driver.findElement(By.xpath(beforexpath +testData.get("Description")+ afterxpath)).isDisplayed();
	    ...
	    public void verify_modified_record_should_get_approved_and_display_in_the_system_under_approved_list_view() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchButton());
	    	covenantMasterObj.covenantMaster_SearchButton().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInputField());
	    	covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Modify Description"));
	    	String beforexpath = "//span[contains(text(),'"; 
	    	String afterxpath = "')]"; 
	    	Thread.sleep(1000);
	    	boolean modifyDescription = driver.findElement(By.xpath(beforexpath +testData.get("Modify Description")+ afterxpath)).isDisplayed();
	    	Assert.assertTrue(modifyDescription);
	    }
...
//	    		testData = excelData.getTestdata("AT_CM_03_D1");
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
			 covenantMasterObj.covenantMaster_CovenantType().click();
			 radioButtonHelper.radioButton(testData.get("Covenant Type"));
	    ...
	    public void enter_remark_for_reject_the_record_of_covenant_master() throws Throwable {
	    	...
	    	covenantMasterObj.covenantMaster_Checker_CheckerRejectRemark().sendKeys(testData.get("Checker Submit Remark"));
	    ...
	    public void verify_all_the_modified_captured_data_from_makers_side_should_not_be_display_in_the_system_under_approved_list_view() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchButton());
	    	covenantMasterObj.covenantMaster_SearchButton().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInputField());
	    	covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Modify Description"));
...
//	    	testData = excelData.getTestdata("AT_CM_04_D1");
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
			 covenantMasterObj.covenantMaster_CovenantType().click();
			 radioButtonHelper.radioButton(testData.get("Covenant Type"));
	    ...
	    public void enter_remark_for_return_the_record_of_covenant_master() throws Throwable {
	    	...
	    	covenantMasterObj.covenantMaster_Checker_CheckerReturnRemark().sendKeys(testData.get("Checker Submit Remark"));
	    ...
	    public void verify_all_the_captured_data_should_be_returned_and_stored_in_the_maker_stage() throws Throwable {
			...
			String beforexpath = "//span[contains(text(),'"; 
	    	String afterxpath = "')]"; 
	    	boolean description3 = driver.findElement(By.xpath(beforexpath +testData.get("Description")+ afterxpath)).isDisplayed();
	    ...
	    public void verify_all_the_modified_captured_data_should_be_returned_and_stored_in_the_maker_stage() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchButton());
	    	covenantMasterObj.covenantMaster_SearchButton().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInputField());
	    	covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Modify Description"));
	    	String beforexpath = "//span[contains(text(),'"; 
	    	String afterxpath = "')]"; 
	    	boolean description3 = driver.findElement(By.xpath(beforexpath +testData.get("Modify Description")+ afterxpath)).isDisplayed();
	    	Assert.assertTrue(description3);
	    }
...
//	    	testData = excelData.getTestdata("AT_CM_05_D1");
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
	    	covenantMasterObj.covenantMaster_CovenantType().click();
	    	radioButtonHelper.radioButton(testData.get("Covenant Type"));
	    	...
	    	for(int i=0; i<=20;i++) {
	    		try {
	    			waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Description());
	    			covenantMasterObj.covenantMaster_Description().sendKeys(testData.get("Special Character Input"));
					break;
				} catch (Exception e) {
					// TODO: handle exception
				}
	    ...
	    public void fill_all_valid_fields_in_the_covenant_master_screen_to_modify_the_record_before_approved() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
			 covenantMasterObj.covenantMaster_CovenantType().click();
//			 testData = excelData.getTestdata("AT_CM_06_D1");
			 radioButtonHelper.radioButton(testData.get("Covenant Type"));
...
//	    	clicksAndActionsHelper.doubleClick(covenantMasterObj.covenantMaster_Description());
	    	...
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Description());
	    	covenantMasterObj.covenantMaster_Description().click();
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Description());
	    	covenantMasterObj.covenantMaster_Description().sendKeys(Keys.chord(Keys.CONTROL, "A"));
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Description());
	    	covenantMasterObj.covenantMaster_Description().sendKeys(testData.get("Modify Description"));
...
//	    	testData= excelData.getTestdata("AT_CM_07_D1");
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchButton());
	    	covenantMasterObj.covenantMaster_SearchButton().click();
	    	
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_SearchInputField());
	    	covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Approved Record"));
	    	
//	    	waithelper.waitForElementwithFluentwait(driver, null);
//	    	span[contains(text(),'')]/../../../td/span/button[1]/span[1]
	    	String beforexpath ="//span[contains(text(),'";
	    	String afterxpath ="')]/../../../td/span/button[1]/span[1]";
	    	waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath(beforexpath +testData.get("Approved Record")+ afterxpath)));
	    ...
	    public void verify_system_should_allow_user_to_modify_the_covenant_master_already_approved_record() throws Throwable {
	    	...
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_CovenantType());
			covenantMasterObj.covenantMaster_CovenantType().click();
//			testData = excelData.getTestdata("AT_CM_012_D1");
			radioButtonHelper.radioButton(testData.get("Modify Covenant Type"));
			...
			waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Frequency());
			covenantMasterObj.covenantMaster_Frequency().click();
			radioButtonHelper.radioButton(testData.get("Modify Frequency"));
...
//			covenantMasterObj.covenantMaster_SaveButton().click();
	    ...
	    public void verify_same_record_should_get_saved_with_the_modified_data_in_the_system() throws Throwable {
	    	...
	    	String beforexpath ="//span[contains(text(),'";
	    	String afterxpath ="')]/../../../td/span/button[1]/span[1]";
	    	waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath(beforexpath +testData.get("Modify Description")+ afterxpath)));
	    	boolean message = driver.findElement(By.xpath(beforexpath +testData.get("Modify Description")+ afterxpath)).isDisplayed();
	    	Assert.assertTrue(message);
...
//	    	covenantMasterObj.covenantMaster_StatusToggle().click();
	    ...
	    public void verify_while_modification_in_covenant_master_record_system_should_not_allow_to_enter_invalid_datatypes() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_Description());
	    	covenantMasterObj.covenantMaster_Description().sendKeys(testData.get("Invalid Data"));
	    ...
	    public void verify_the_view_workflow_in_the_covenant_master() throws Throwable {
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_ViewSummaryButton());
	    	clicksAndActionsHelper.doubleClick(covenantMasterObj.covenantMaster_ViewSummaryButton());
//	    	covenantMasterObj.covenantMaster_ViewSummaryButton().click();
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, covenantMasterObj.covenantMaster_UserID(), 10, 2);
	    	String UserID = covenantMasterObj.covenantMaster_UserID().getText();
	    	System.out.println("UserID:"+UserID);
	    	covenantMasterObj.covenantMaster_UserID().isDisplayed();
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, covenantMasterObj.covenantMaster_StageCode(), 10, 2);
	    	...
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, covenantMasterObj.covenantMaster_Status(), 10, 2);
	    	String Status = covenantMasterObj.covenantMaster_Status().getText();
	    	System.out.println("Status:"+Status);
	    	covenantMasterObj.covenantMaster_Status().isDisplayed();
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, covenantMasterObj.covenantMaster_StartTime(), 10, 2);
	    	...
	    	waithelper.waitForElementToVisibleWithFluentWait(driver, covenantMasterObj.covenantMaster_EndTime(), 10, 2);
...
//			}
			...
			for (int i = 0; i < 10; i++) {
				try {
					boolean result = driver.findElement(By.xpath(beforexpath +testData.get("Approved Record")+ afterxpath)).isDisplayed();
	    ...
	    public void verify_search_box_should_not_display_any_record_with_mismatched_data_in_covenant_master() throws Throwable {
	    	...
	    	covenantMasterObj.covenantMaster_SearchInputField().sendKeys(testData.get("Invalid Data"));
	    	waithelper.waitForElementwithFluentwait(driver, covenantMasterObj.covenantMaster_NoDataFoundInSearch());
...
//	    	softAssert.assertTrue(result);
	    ...
	    public void select_data_set_id_for_covenant_master_testcase001() throws Throwable {
	    	dataSetID = "AT_CM_01_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase002$")
	    public void select_data_set_id_for_covenant_master_testcase002() throws Throwable {
	    	dataSetID = "AT_CM_02_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase003$")
	    public void select_data_set_id_for_covenant_master_testcase003() throws Throwable {
	    	dataSetID = "AT_CM_03_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase004$")
	    public void select_data_set_id_for_covenant_master_testcase004() throws Throwable {
	    	dataSetID = "AT_CM_04_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase005$")
	    public void select_data_set_id_for_covenant_master_testcase005() throws Throwable {
	    	dataSetID = "AT_CM_05_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase006$")
	    public void select_data_set_id_for_covenant_master_testcase006() throws Throwable {
	    	dataSetID = "AT_CM_06_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase007$")
	    public void select_data_set_id_for_covenant_master_testcase007() throws Throwable {
	    	dataSetID = "AT_CM_07_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase008$")
	    public void select_data_set_id_for_covenant_master_testcase008() throws Throwable {
	    	dataSetID = "AT_CM_08_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase009$")
	    public void select_data_set_id_for_covenant_master_testcase009() throws Throwable {
	    	dataSetID = "AT_CM_09_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase010$")
	    public void select_data_set_id_for_covenant_master_testcase010() throws Throwable {
	    	dataSetID = "AT_CM_010_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase011$")
	    public void select_data_set_id_for_covenant_master_testcase011() throws Throwable {
	    	dataSetID = "AT_CM_011_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase012$")
	    public void select_data_set_id_for_covenant_master_testcase012() throws Throwable {
	    	dataSetID = "AT_CM_012_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }

	    @Then("^select data set ID for covenant master testcase013$")
	    public void select_data_set_id_for_covenant_master_testcase013() throws Throwable {
	    	dataSetID = "AT_CM_013_D1";
	        testData = excelData.getTestdata(dataSetID);
	    }
