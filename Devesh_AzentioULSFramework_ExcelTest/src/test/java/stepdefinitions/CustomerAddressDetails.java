...
public class CustomerAddressDetails {
    ...
    public void enter_the_reference_id_of_the_customer_address_details_record() throws Throwable {
    	...
    	customerAddressDetailsObj.customerAddressDetails_SearchInboxInputField().sendKeys(testData.get("Application id"));
    ...
    public void select_the_customer_address_details_record_from_the_customer_personal_detail_screen() throws Throwable {
    	...
    	customerAddressDetailsObj.customerAddressDetails_SearchInputField().sendKeys(testData.get("Customer First Name"));
    	String beforexpath= "//span[contains(text(),'"; 
...
//    	customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchInputField().sendKeys(customerAddressDetailsTestDataType.AddressTypeCode);
    	...
    	Thread.sleep(1000);
    	waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath(beforexpath +testData.get("Address Type")+ afterxpath)));
    	driver.findElement(By.xpath(beforexpath +testData.get("Address Type")+ afterxpath)).click();
...
//    	Assert.assertTrue(status22);
    ...
    public void verify_while_modification_system_should_allow_user_to_save_the_address_details_record_with_valid_data() throws Throwable {
    	...
    	waithelper.waitForElementwithFluentwait(driver, customerAddressDetailsObj.customerAddressDetails_AddressLine1Field());
    	customerAddressDetailsObj.customerAddressDetails_AddressLine1Field().sendKeys(testData.get("Modify Address Line1"));
    ...
    public void verify_system_should_show_the_proper_validation_message_for_blank_field_while_modifying_address_detail_record() throws Throwable {
    	...
    	String validationMessage = driver.findElement(By.xpath(beforexpath+testData.get("MandatoryFieldNameToModify")+afterxpath)).getText();
    	System.out.println("Blank Field Validation Message :"+validationMessage);
    	boolean status = driver.findElement(By.xpath(beforexpath+testData.get("MandatoryFieldNameToModify")+afterxpath)).isDisplayed();
    	Assert.assertTrue(status);
    }
    ...
    public void verify_system_should_not_allow_user_to_do_a_modification_with_invalid_data_of_address_detail_record() throws Throwable {
    	Thread.sleep(500);
    	waithelper.waitForElementwithFluentwait(driver, customerAddressDetailsObj.customerAddressDetails_AddressLine1Field());
    	customerAddressDetailsObj.customerAddressDetails_AddressLine1Field().sendKeys(testData.get("InvalidInput"));
    	waithelper.waitForElementwithFluentwait(driver, customerAddressDetailsObj.customerAddressDetails_AddressDetailsSaveButton());
    	customerAddressDetailsObj.customerAddressDetails_AddressDetailsSaveButton().click();
    	String beforexpath = "//ion-label[contains(text(),'";
    	String afterxpath = "')]/ancestor::ion-col/descendant::ion-badge";
...
//		}
    	try {
    		customerAddressDetailsObj.customerAddressDetails_AddressTypeFirstValue().sendKeys("ok");
    	...
    	try {
    		customerAddressDetailsObj.customerAddressDetails_CountryFirstValue().sendKeys("ok");
    	...
    	try {
    		customerAddressDetailsObj.customerAddressDetails_OccupancyStatusFirstValue().sendKeys("ok");
    	...
    	try {
    		customerAddressDetailsObj.customerAddressDetails_OccupanceSinceFirstValue().sendKeys("ok");
    	...
    	try {
    		customerAddressDetailsObj.customerAddressDetails_ContactAddressFirstValue().sendKeys("ok");
    ...
    public void verify_search_box_should_display_matching_record_with_matched_data_of_customer_address_details() throws Throwable {
    	...
    	for (int i = 0; i <20; i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver, customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchInputField());
				customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchInputField().sendKeys(testData.get("Address Type"));
				break;
			} catch (Exception e) {
				// TODO: handle exception
			}
...
//    	clicksAndActionsHelper.JSEClick(customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchCloseButton());
    ...
    public void verify_search_box_should_not_display_any_record_with_mismatched_data_of_customer_address_details() throws Throwable {
    	...
    	customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchButton().click();
    	Thread.sleep(1000);
    	customerAddressDetailsObj.customerAddressDetails_AddressDetailSearchInputField().sendKeys(testData.get("Invalid Input"));
...
//    public void select_data_set_id_for_customer_address_details_testcase002() throws Throwable {
//    	dataSetID = "AT_CAD_002_D1";
//        testData = excelData.getTestdata(dataSetID);
//    }

    @Then("^select data set ID for customer address details testcase003$")
    public void select_data_set_id_for_customer_address_details_testcase003() throws Throwable {
    	dataSetID = "AT_CAD_003_D1";
        testData = excelData.getTestdata(dataSetID);
    }

//    @Then("^select data set ID for customer address details testcase004$")
//    public void select_data_set_id_for_customer_address_details_testcase004() throws Throwable {
//    	dataSetID = "AT_CAD_004_D1";
//        testData = excelData.getTestdata(dataSetID);
//    }

    @Then("^select data set ID for customer address details testcase005$")
    public void select_data_set_id_for_customer_address_details_testcase005() throws Throwable {
    	dataSetID = "AT_CAD_005_D1";
        testData = excelData.getTestdata(dataSetID);
    }
...
//    }
    ...
    public void select_data_set_id_for_customer_address_details_testcase008() throws Throwable {
    	dataSetID = "AT_CAD_008_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for customer address details testcase009$")
    public void select_data_set_id_for_customer_address_details_testcase009() throws Throwable {
    	dataSetID = "AT_CAD_009_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for customer address details testcase010$")
    public void select_data_set_id_for_customer_address_details_testcase010() throws Throwable {
    	dataSetID = "AT_CAD_010_D1";
        testData = excelData.getTestdata(dataSetID);
    }
