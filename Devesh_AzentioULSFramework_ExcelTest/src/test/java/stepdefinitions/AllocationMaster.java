	...
	List<String> xlsList = new ArrayList<>();
	 ...
	 @And("^Click the eye icon of the alloction master$")
	    public void click_the_eye_icon_of_the_alloction_master() throws Throwable {
		 //action.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, allocationMstObj.AllocationMaster_EyeIcon(), 60, 2);
		 for(int i=0; i<20; i++) {
			 try {
	 ...
	 @Then("^Click the add button in the allocation master$")
	    ...
	    public void search_the_record_in_allocation_master() throws Throwable {
			 ...
			 waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.AllocationMaster_SearchText(), 60, 2);
				...
				allocationMstObj.AllocationMaster_SearchText().sendKeys(testData.get("Approved Record"));
	 ...
	 // *******Checker Stage***********************//
		...
		public void get_the_url_and_login_as_checkers() throws Throwable {
			String kulsApplicationUrl = configFileRead.getApplicationUATUrl();
...
public void to_verify_the_functionality_of_search_box_with_matching_data_in_alloction_master_list_view() throws Throwable {
	...
	allocationMstObj.AllocationMaster_ListViewSearchText().sendKeys(testData.get("Approved Record"));
...
public void to_verify_the_functionality_of_search_box_with_mismatch_data_in_allocation_master_in_list_view() throws Throwable {
	...
	allocationMstObj.AllocationMaster_ListViewSearchText().click();
	allocationMstObj.AllocationMaster_ListViewSearchText().sendKeys(testData.get("Unmatched Data"));
	Thread.sleep(1000);
...
public void fill_the_level_no_in_allocation_details() throws Throwable {
	//waitForElementToVisibleWithFluentWait(driver, allocationMstObj.allocationDetail_LevelNo(), 60, 2);
	for(int i=0; i<20; i++) {
		try {
...
@Then("^Click the first action icon in allocation master$")
public void click_the_first_action_icon_in_allocation_master() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.AllocationDetails_EditIcon(), 60, 2);
	allocationMstObj.AllocationDetails_EditIcon().click();
}


@And("^validate the required field in allocation master$")
public void validate_the_required_field_in_allocation_master() throws Throwable {
	WebElement nameErrorMessage = driver
			.findElement(By.xpath("(//ion-badge[contains(text(),'Required field')])[1]"));
	String expectedErrorText = "Required field";
	String actualErrorText = nameErrorMessage.getText();
...
public void modify_the_allocation_based_on_in_allocation_detail() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.allocationDetail_AllocationBasedOn_Dropdown_Modification(), 60, 2);
	allocationMstObj.allocationDetail_AllocationBasedOn_Dropdown_Modification().click();
	String xpath ="//ion-label[text()=' "+testData.get("Allocation Based On")+" ']//following-sibling::ion-radio";
	for (int i = 0; i <200; i++) {
		try {
			driver.findElement(By.xpath(xpath)).click();
			break;
...
public void modify_the_order_by_value_in_allocation_details() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.allocationDetail_OrderBy_Dropdown_Modification(), 60, 2);
	allocationMstObj.allocationDetail_OrderBy_Dropdown_Modification().click();
	String xpath ="//ion-label[text()=' "+testData.get("Order By")+" ']//following-sibling::ion-radio";
	for (int i = 0; i <200; i++) {
		try {
			driver.findElement(By.xpath(xpath)).click();
			break;
...
public void click_the_first_edit_icon_in_allocation_details() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.AllocationDetails_EditIcon(), 60, 2);
	allocationMstObj.AllocationDetails_EditIcon().click();
}

@And("^Modify the leval no in allocation details$")
public void modify_the_leval_no_in_allocation_details() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver,allocationMstObj.allocationDetail_LevelNo(), 60, 2);
	allocationMstObj.allocationDetail_LevelNo().click();
	for (int i = 0; i <30; i++) {
		try {
			allocationMstObj.allocationDetail_LevelNo().clear();
			allocationMstObj.allocationDetail_LevelNo().sendKeys(testData.get("Level No"));
			break;
		} catch (Exception e) {
...
public void click_the_updation_button_in_allocation_details() throws Throwable {
	waitHelper.waitForElementToVisibleWithFluentWait(driver, allocationMstObj.allocationDetail_Updation(), 60, 2);
	allocationMstObj.allocationDetail_Updation().click();
}
}
