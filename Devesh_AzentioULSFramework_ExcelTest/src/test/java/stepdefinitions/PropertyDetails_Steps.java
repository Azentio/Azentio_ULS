...
public class PropertyDetails_Steps extends BaseClass {
	...
	PropetyDetails_TestDataType propertyDetailsTestData = jsonConfig.getPropertyDetailTestDataByName("Maker");
	...
	public void search_for_app_data_entry_record() throws Throwable {
		...
		ulsCommonElementObj.ulsNotificationSearchTextBox().sendKeys(testData.get("StageCode"));
		Thread.sleep(400);
	}
