...
//	ExcelData excelData = new ExcelData("C:\\Users\\inindc00091\\eclipse-workspace\\Devesh_AzentioULSFramework_ExcelTest\\Test-data\\TestDataDesignSample.xlsx","AssetCollateralTypeTestData","Data Set ID");
	ExcelData excelData = new ExcelData("C:\\Users\\inindc00091\\eclipse-workspace\\Devesh_AzentioULSFramework_ExcelTest\\Test-data\\ULS_TestDataForTesting.xlsx","AssetCollateralTypeTestData","Data Set ID");
	...
	public void user_should_navigate_to_asset_collateral_config() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_ModuleName());
		assetCollateralTypeObj.assetCollateralType_ModuleName().click();
		radioButtonHelper.radioButton("LOS");
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_MenuToggle());
		assetCollateralTypeObj.assetCollateralType_MenuToggle().click();
		...
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.config_Manager());
		assetCollateralTypeObj.config_Manager().click();
	}
	...
	public void verify_the_description_field_should_be_editable_mandatory_and_multilingual() throws Throwable {
		...
		boolean status = assetCollateralTypeObj.assetCollateralType_DescriptionEditable().getAttribute("ng-reflect-readonly").equalsIgnoreCase("false");
...
//		testData = excelData.getTestdata("AT_ACT_01_D1");
		...
		assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField().sendKeys(testData.get("Description French"));
		...
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField());
		assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField().sendKeys(testData.get("Description German"));
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save());
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save().click();
		...
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField());
		assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField().sendKeys(testData.get("Description Arabic"));
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save());
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save().click();
		...
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField());
		assetCollateralTypeObj.assetCollateralType_DescriptionSelectedLanguageInputField().sendKeys(testData.get("Description English"));
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save());
		assetCollateralTypeObj.assetCollateralType_DescriptionMultilingual_Save().click();
	...
	public void verify_the_field_asset_collateral_type_code_should_be_mandatory_editable_and_unique_code() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode());
		assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().sendKeys(testData.get("Asset/Collateral Type Code"));
		boolean status = assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCodeEditable().getAttribute("ng-reflect-readonly").equalsIgnoreCase("false");
		Assert.assertEquals(status, true);
	}
	...
	public void verify_the_field_asset_collateral_category_should_be_mandatory_and_editable() throws Throwable {
		...
		boolean status = assetCollateralTypeObj.assetCollateralType_AssetCollateralCategory().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertEquals(status, true);
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_AssetCollateralCategory());
		assetCollateralTypeObj.assetCollateralType_AssetCollateralCategory().click();
		radioButtonHelper.radioButton(testData.get("Asset/Collateral Category"));
	}
	...
	public void verify_the_field_module_should_be_mandatory_editable_dropdown_should_show_the_list_of_modules() throws Throwable {
		...
		boolean status = assetCollateralTypeObj.assetCollateralType_Module().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("false");
		Assert.assertEquals(status, true);
...
//		Thread.sleep(1000);
	...
	public void verify_the_field_haircut_percent_should_be_mandatory_editable_and_upto_4_decimal_places_allowed() throws Throwable {
		...
		boolean status = assetCollateralTypeObj.assetCollateralType_HairCutPercentEditable().getAttribute("ng-reflect-readonly").equalsIgnoreCase("false");
		Assert.assertEquals(status, true);
		assetCollateralTypeObj.assetCollateralType_HairCutPercent().sendKeys(testData.get("HairCut %"));
...
//		assetCollateralTypeObj.assetCollateralType_HairCutPercent().sendKeys("2.0000");
	...
	public void verify_the_field_remarks_should_be_mandatory_and_editable_textarea() throws Throwable {
		...
		boolean status = assetCollateralTypeObj.assetCollateralType_RemarksEditable().getAttribute("ng-reflect-readonly").equals("false");
		Assert.assertEquals(status, true);
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Remarks());
		assetCollateralTypeObj.assetCollateralType_Remarks().sendKeys(testData.get("Remarks"));
	}
...
//  }
    ...
    public void confirmation_message_displays_with_reference_id() throws Throwable {
		String message = assetCollateralTypeObj.assetCollateralType_SaveConfirmationMessage().getText();
...
//	  	boolean status = assetCollateralTypeObj.assetCollateralType_SaveConfirmationMessageCloseButton().isDisplayed();
...
//		assetCollateralTypeObj.assetCollateralType_NewSavedRecord().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Maker_SearchInbox());
		assetCollateralTypeObj.assetCollateralType_Maker_SearchInbox().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Maker_SearchInboxInputField());
		assetCollateralTypeObj.assetCollateralType_Maker_SearchInboxInputField().sendKeys(testData.get("Reference ID"));
	...
	public void click_on_submit_button_to_submit_the_record_of_collateral_type() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_MakerSubmitRemark().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_MakerSubmitRemark());
		assetCollateralTypeObj.assetCollateralType_MakerSubmitRemark().sendKeys(testData.get("Maker Submit Remark"));
	...
	public void select_the_record_of_collateral_type_to_approve() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_Checker_SearchInboxInputField().sendKeys(testData.get("Reference ID"));
	...
	public void enter_remark_for_approve_the_record_of_collateral_type() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerApproveRemark().click();
		waithelper.waitForElementToVisibleWithFluentWait(driver, assetCollateralTypeObj.assetCollateralType_Checker_CheckerApproveRemark(), 10, 2);
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerApproveRemark().sendKeys(testData.get("Checker Submit Remark"));
    ...
    public void verify_all_the_captured_data_from_makers_side_should_be_saved_and_stored_in_the_system() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Asset/Collateral Type Code"));
...
//		Assert.assertTrue(makerrecord);
		String beforexpath = "//span[contains(text(),'"; 
    	String afterxpath = "')]"; 
    	boolean modifiedCollateraltypecode = driver.findElement(By.xpath(beforexpath +testData.get("Asset/Collateral Type Code")+ afterxpath)).isDisplayed();
    	Assert.assertTrue(modifiedCollateraltypecode);
	}
	
	@Then("^verify all the captured modified data from makers side should be saved and stored in the system$")
	public void verify_all_the_captured_modified_data_from_makers_side_should_be_saved_and_stored_in_the_system() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchButton());
		assetCollateralTypeObj.assetCollateralType_SearchButton().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
		assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Modify Asset/Collateral Type Code"));
//		boolean makerrecord = assetCollateralTypeObj.assetCollateralType_ListViewFirstFieldOfAssetCollateralTypeCode().isDisplayed();
//		Assert.assertTrue(makerrecord);
		String beforexpath = "//span[contains(text(),'"; 
		String afterxpath = "')]"; 
		boolean modifiedCollateraltypecode = driver.findElement(By.xpath(beforexpath +testData.get("Modify Asset/Collateral Type Code")+ afterxpath)).isDisplayed();
		Assert.assertTrue(modifiedCollateraltypecode);
	}
	...
	public void verify_all_the_captured_modified_data_from_makers_side_should_not_be_saved_and_stored_in_the_system() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchButton());
		assetCollateralTypeObj.assetCollateralType_SearchButton().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
		assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Modify Asset/Collateral Type Code"));
...
//		Assert.assertTrue(makerrecord);
		String beforexpath = "//span[contains(text(),'"; 
    	String afterxpath = "')]"; 
    	boolean assetcollateraltypecode3 = driver.findElement(By.xpath(beforexpath +testData.get("Asset/Collateral Type Code")+ afterxpath)).isDisplayed();
	...
	public void verify_all_the_captured_modified_data_from_makers_side_should_be_moved_back_and_stored_in_the_maker_stage() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchButton());
		assetCollateralTypeObj.assetCollateralType_SearchButton().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
		assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Modify Asset/Collateral Type Code"));
...
//		Assert.assertTrue(makerrecord);
		...
		String afterxpath = "')]";
		Thread.sleep(1000);
		boolean assetcollateraltypecode3 = driver.findElement(By.xpath(beforexpath +testData.get("Modify Asset/Collateral Type Code")+ afterxpath)).isDisplayed();
		Assert.assertTrue(assetcollateraltypecode3);
	}
...
//		xpath - //span[contains(text(),'5550')]/../../td[1]/button
	...
	public void enter_remark_for_reject_the_record_of_collateral_type() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerRejectRemark().click();
		waithelper.waitForElementToVisibleWithFluentWait(driver, assetCollateralTypeObj.assetCollateralType_Checker_CheckerRejectRemark(), 10, 2);
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerRejectRemark().sendKeys(testData.get("Checker Submit Remark"));
	}
	...
	public void fill_all_valid_fields_in_the_screen_for_approve_the_record() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Description());
		assetCollateralTypeObj.assetCollateralType_Description().sendKeys(testData.get("Description"));
		...
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Module());
		assetCollateralTypeObj.assetCollateralType_Module().click();
		radioButtonHelper.radioButton(testData.get("Module"));

		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_IFRS());
		assetCollateralTypeObj.assetCollateralType_IFRS().click();
		radioButtonHelper.radioButton(testData.get("IFRS"));
...
//		testData = excelData.getTestdata("AT_ACT_04_D1");
		kulsLogin.ulSApplicationLoginAsAChecker(testData.get("Checker id"));
	}
...
//	xpath - //span[contains(text(),'5550')]/../../td[1]/button
	...
	public void enter_remark_for_return_the_record_of_collateral_type() throws Throwable {
		...
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerReturnRemark().click();
		waithelper.waitForElementToVisibleWithFluentWait(driver, assetCollateralTypeObj.assetCollateralType_Checker_CheckerReturnRemark(), 10, 2);
		assetCollateralTypeObj.assetCollateralType_Checker_CheckerReturnRemark().sendKeys(testData.get("Checker Submit Remark"));
	}
...
//		testData = excelData.getTestdata("AT_ACT_08_D1");
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchButton());
		assetCollateralTypeObj.assetCollateralType_SearchButton().click();
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
    	assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Asset/Collateral Type Code"));
//      xpath-	(//span[contains(text(),'depo30')]/../../../td[1]/span[1]/button[1]/span[1])[1]
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(beforexpath + testData.get("Asset/Collateral Type Code") + afterxpath)).click();
...
//    	assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().click();
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode());
    	assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().sendKeys(testData.get("Invalid Data"));
    ...
    public void values_in_list_view_should_not_be_editable_in_list_of_asset_collateral_type_screen() throws Throwable {
    	try {
    		...
    		System.out.println("AssetCollateralTypeCode Value in list view is editable");
    		
    	}catch(Exception e) {
    		System.out.println("AssetCollateralTypeCode Value in list view is not editable");
    	}
    	try {
    		assetCollateralTypeObj.assetCollateralType_ListViewFirstFieldOfDescription().sendKeys("ok");
    		System.out.println("Description Value in list view is editable");
    		
    	}catch(Exception e) {
    		System.out.println("Description Value in list view is not editable");
    	}
    	try {
    		assetCollateralTypeObj.assetCollateralType_ListViewFirstFieldOfAssetCollateralCategoryDescription().sendKeys("ok");
    		System.out.println("AssetCollateralCategoryDescription Value in list view is editable");
    		
    	}catch(Exception e) {
    		System.out.println("AssetCollateralCategoryDescription Value in list view is not editable");
    	}
    }
...
//    	testData = excelData.getTestdata("AT_ACT_11_D1");
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
    	assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Asset/Collateral Type Code"));
...
//    	Assert.assertTrue(assetcollateraltypecode);
    	...
    	String afterxpath = "')]";
    	Thread.sleep(1000);
    	boolean assetcollateraltypecode1 = driver.findElement(By.xpath(beforexpath +testData.get("Asset/Collateral Type Code")+ afterxpath)).isDisplayed();
    ...
    public void verify_search_box_should_not_display_any_record_with_mismatched_data_in_collateral_type() throws Throwable {
    	...
    	assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Invalid Data"));
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_NoDataFoundInSearch());
    ...
    public void system_should_show_asset_collateral_category_description_field_and_the_field_will_display_only() throws Throwable {
    	...
    	try {
    		...
    		System.out.println("Asset/Collateral Category Description Field is not display only");
    	}catch(Exception e) {
    		System.out.println("Asset/Collateral Category Description Field is display only");
    	}
    }
    ...
    public void system_should_show_authorization_status_field_and_the_field_will_display_only() throws Throwable {
    	...
    	try {
    		...
    		System.out.println("Authorization Status Field is not display only");
    	}catch(Exception e) {
    		System.out.println("Authorization Status Field in list view is display only");
    	}
    }
...
//    	testData = excelData.getTestdata("AT_ACT_10_D1");
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchButton());
    	assetCollateralTypeObj.assetCollateralType_SearchButton().click();
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_SearchInputField());
    	assetCollateralTypeObj.assetCollateralType_SearchInputField().sendKeys(testData.get("Approved Record"));
//      xpath-	(//span[contains(text(),'depo30')]/../../../td[1]/span[1]/button[1]/span[1])[1]
    	String beforexpath = "(//span[contains(text(),'";
		String afterxpath = "')]/../../../td[1]/span[1]/button[1]/span[1])[1]";
		Thread.sleep(2000);
...
//    	testData = excelData.getTestdata("AT_ACT_06_D1");
    	waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Description());
		assetCollateralTypeObj.assetCollateralType_Description().click();
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Description());
		assetCollateralTypeObj.assetCollateralType_Description().sendKeys(Keys.chord(Keys.CONTROL,"A"));
		assetCollateralTypeObj.assetCollateralType_Description().sendKeys(testData.get("Modify Description"));

		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode());
		assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().sendKeys(Keys.chord(Keys.CONTROL,"A"));
		assetCollateralTypeObj.assetCollateralType_AssetCollateralTypeCode().sendKeys(testData.get("Modify Asset/Collateral Type Code"));

		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_AssetCollateralCategory());
		assetCollateralTypeObj.assetCollateralType_AssetCollateralCategory().click();
		radioButtonHelper.radioButton(testData.get("Modify Asset/Collateral Category"));

		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Module());
		assetCollateralTypeObj.assetCollateralType_Module().click();
		radioButtonHelper.radioButton(testData.get("Modify Module"));

		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_IFRS());
		assetCollateralTypeObj.assetCollateralType_IFRS().click();
		radioButtonHelper.radioButton(testData.get("Modify IFRS"));

		while (true) {
			try {
				waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_HairCutPercent());
				assetCollateralTypeObj.assetCollateralType_HairCutPercent().sendKeys(Keys.chord(Keys.CONTROL,"A"));
				assetCollateralTypeObj.assetCollateralType_HairCutPercent().sendKeys(testData.get("Modify HairCut %"));
				break;
		...
		waithelper.waitForElementwithFluentwait(driver, assetCollateralTypeObj.assetCollateralType_Remarks());
		assetCollateralTypeObj.assetCollateralType_Remarks().sendKeys(Keys.chord(Keys.CONTROL,"A"));
		assetCollateralTypeObj.assetCollateralType_Remarks().sendKeys(testData.get("Modify Remarks"));
...
//    	testData=excelData.getTestdata("AT_ACT_12_D1");
    	collateralTypeObj.AssetCollateralType_ListViewSearchText().click();
    	collateralTypeObj.AssetCollateralType_ListViewSearchText().sendKeys(testData.get("Asset/Collateral Type Code"));
Assert.assertEquals(collateralTypeObj.AssetCollateralType_ListViewMachedData().isDisplayed(), true);
    ...
    public void to_verify_the_functionality_of_search_box_with_unmatching_data_in_collateraltype_master() throws Throwable {
    	...
    	collateralTypeObj.AssetCollateralType_ListViewSearchText().click();
    	collateralTypeObj.AssetCollateralType_ListViewSearchText().sendKeys(testData.get("Invalid Data"));
    	Thread.sleep(1000);
    ...
    public void to_verify_the_functionality_of_export_to_pdf_button_in_collateraltype_master() throws Throwable {
        ...
        File file = new File("C:\\Users\\inindc00091");
    ...
    public void click_the_view_summary_button_in_collateral_type_master() throws Throwable {
		...
		// collateralTypeObj.AssetCollateralType_ActionIcon(), 60, 2);
    ...
    public void select_data_set_id_for_asset_collateral_type_testcase001() throws Throwable {
    	dataSetID = "AT_ACT_01_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase002$")
    public void select_data_set_id_for_asset_collateral_type_testcase002() throws Throwable {
    	dataSetID = "AT_ACT_02_D1";
//    	dataSetID = "AT_ACT_02_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase003$")
    public void select_data_set_id_for_asset_collateral_type_testcase003() throws Throwable {
    	dataSetID = "AT_ACT_03_D1";
//    	dataSetID = "AT_ACT_03_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase004$")
    public void select_data_set_id_for_asset_collateral_type_testcase004() throws Throwable {
    	dataSetID = "AT_ACT_04_D1";
//    	dataSetID = "AT_ACT_04_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase005$")
    public void select_data_set_id_for_asset_collateral_type_testcase005() throws Throwable {
    	dataSetID = "AT_ACT_05_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase006$")
    public void select_data_set_id_for_asset_collateral_type_testcase006() throws Throwable {
    	dataSetID = "AT_ACT_06_D1";
//    	dataSetID = "AT_ACT_06_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase007$")
    public void select_data_set_id_for_asset_collateral_type_testcase007() throws Throwable {
    	dataSetID = "AT_ACT_07_D1";
//    	dataSetID = "AT_ACT_07_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase008$")
    public void select_data_set_id_for_asset_collateral_type_testcase008() throws Throwable {
    	dataSetID = "AT_ACT_08_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase009$")
    public void select_data_set_id_for_asset_collateral_type_testcase009() throws Throwable {
    	dataSetID = "AT_ACT_09_D1";
//    	dataSetID = "AT_ACT_09_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase010$")
    public void select_data_set_id_for_asset_collateral_type_testcase010() throws Throwable {
    	dataSetID = "AT_ACT_10_D1";
//    	dataSetID = "AT_ACT_10_D6";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase011$")
    public void select_data_set_id_for_asset_collateral_type_testcase011() throws Throwable {
    	dataSetID = "AT_ACT_11_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase012$")
    public void select_data_set_id_for_asset_collateral_type_testcase012() throws Throwable {
    	dataSetID = "AT_ACT_12_D1";
        testData = excelData.getTestdata(dataSetID);
    }

    @Then("^select data set ID for asset collateral type testcase013$")
    public void select_data_set_id_for_asset_collateral_type_testcase013() throws Throwable {
    	dataSetID = "AT_ACT_13_D1";
        testData = excelData.getTestdata(dataSetID);
    }
