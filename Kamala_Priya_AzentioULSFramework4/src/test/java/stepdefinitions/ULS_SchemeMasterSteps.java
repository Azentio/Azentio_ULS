...
public class ULS_SchemeMasterSteps extends BaseClass {
	...
	//lULS_SchemeMasterTestDataType ulSchemeMasterTestData = jsonConfig.getUlsSchemeMasterTestDataByName("Maker");
	ClicksAndActionsHelper clicksAndActionsHelper = new ClicksAndActionsHelper(driver);
	JsonDataReaderWriter jsonDataReadertWriter = new JsonDataReaderWriter();
	SoftAssert softAssert = new SoftAssert();
	String filePath=System.getProperty("user.dir")+"\\Test-data\\UlsTestDataDesign.xlsx";
	...
	//public void login_with_valid_maker_credentials() throws Throwable {
		...
		//testData=ExcelDataForMakerLogin.getTestdata("Maker3");
...
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.ulsSchemeAMasterViewIcon(), 10, 10);
		for(int i=0;i<=30;i++)
		{
			try
			{
	...
	public void verify_back_and_save_buttons_are_visible() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterBackButton(), 10, 10);

		Assert.assertTrue(ulsSchemeMasterObj.schemeMasterBackButton().isDisplayed());
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSaveButton(), 10, 10);
	...
	public void verify_description_field_should_be_mendatory_and_user_can_able_to_pass_the_data_in_it_for_checker_return()
		...
		ulsSchemeMasterObj.schemeMasterDescriptionTextBox()
				.sendKeys(schemeMasterTestData.get("UlsDescriptionForCheckerReturn"));
	}
	...
	public void verify_product_type_should_be_mendatory_field_and_user_can_able_to_choose_the_product_type_for_checker_return()
		...
		// ulsSchemeMasterObj.schemeMasterProductTypeDropDown().click();
		String xpath = "//ion-label[text()=' " + schemeMasterTestData.get("UlsProductTypeForCheckerReturn")
	...
	public void verify_product_sub_type_should_be_mendatory_field_and_user_can_able_to_choose_the_product_sub_type_dropdown_for_checker_return()
		...
		String xpath = "//ion-label[text()=' " + schemeMasterTestData.get("UlsSubProductTypeForCheckerReturn")
				+ " ']/parent::ion-item/ion-radio";
		for (int i = 0; i <= 110; i++) {
			try {
				javascriptHelper.scrollIntoView(driver.findElement(By.xpath(xpath)));
	...
	public void verify_indexation_currency_field_should_be_non_mendatory_and_user_can_able_to_select_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterIndexationCurrencyDropDwon(), 10, 1);
	...
	public void verify_valid_from_calendar_field_field_should_be_mendatory_and_user_can_able_to_slecet_the_date()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterValidFromDate(), 10, 1);
...
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterTodayDate(), 10, 1);
	...
	public void verify_valid_to_date_calendar_field_should_be_mendatory_and_user_can_able_to_slecet_the_to_date()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterValidToDate(), 10, 1);
...
//				ulsSchemeMasterObj.schemeMasterMinFinanceAmountMendatoryField(), 3, 1);
	...
	public void verify_repayment_type_field_should_be_mendatory_user_can_able_to_choose_the_data() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterRepaymentType(), 10, 1);
	...
	public void verify_flat_reducing_drop_down_field_should_be_mendatory_user_can_able_to_slecet_the_data()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterFlatReducing(), 10, 1);
	...
	public void verify_inst_due_method_field_should_be_mendatory_user_can_able_to_slect_the_data_in_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterInstDuedateMethod(), 10,
				1);
	...
	public void verify_principal_repayment_frequency_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterPrincipalRepaymentFrequency(), 10, 1);
	...
	public void verify_intereset_repayment_frequency_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterInterestRepaymentFrequencyDropDown(), 10, 1);
	...
	public void verify_loan_eligibility_calc_field_should_be_mendatory_and_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterLoanEligibilityCalcDropDown(), 10, 1);
	...
	public void verify_include_co_applicant_inc_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterIncludeCoApplicantDropDown(), 10, 1);
	...
	public void verify_include_guarantorinc_field_should_be_mendatory_and_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMaster_IncludeGuarantorDropDown(), 10, 1);
	...
	public void verify_due_period_required_field_should_be_mendatory_and_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterDuePeriodRequiredDropDown(), 10, 1);
	...
	public void verify_days_in_year_field_should_be_mendatory_user_can_able_to_select_the_data_from_dropdown()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterDaysInYearDropDown(), 10,
				1);
	...
	public void verify_multiple_disburs_tranch_allowed_field_should_be_mendatory_and_user_can_able_to_slecet_the_data_from_the_dropdown()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterMultipleDisBursTranchAllowdDropDown(), 10, 1);
	...
	public void verify_round_off_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterRoundOffDropDown(), 10,
				1);
	...
	public void verify_appropriation_code_field_should_be_mendatory_user_can_able_to_slecet_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterAppropriationCode(), 10,
				1);
	...
	public void verify_day_count_for_bpi_field_should_be_non_mendatory_and_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterDayCountConventionForBPIDropdown(), 10, 1);
...
//			throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterDiscountFactorRoundingTextBox(), 10,
//				1);
...
//	}
	...
	public void verify_interest_charging_starts_from_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterInterestChargingStartFromDropDown(), 10,
//				1);
	...
	public void verify_mi_recovery_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_dropdown()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterMIRecoveryDropDown(), 10,
				1);
	...
	public void verify_installment_recovery_type_field_should_be_non_mendatiry_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterInstallmentRecoveryTypeDropDown(), 10, 1);
	...
	public void verify_rate_type_field_should_be_non_mendatory_user_can_able_to_select_the_dta_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterRateTypeDropDown(), 10,
				1);
	...
	public void verify_initiate_disc_factory_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterInitiateDiscFactorDropDown(), 10, 1);
	...
	public void verify_reschedulement_lock_in_starts_field_should_be_non_mendatory_user_can_able_to_slect_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterRechedulementLockinStartsFromDropDown(), 10, 1);
	...
	public void verify_bulk_payment_lock_in_starts_from_field_should_be_non_mendatory_user_can_able_to_select_the_data_teh_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterBulkPaymentLockInStartsFromDropDown(), 10, 1);
	...
	public void verify_innediate_due_date_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterImmediateDueDateDropDown(), 10,
//				1);
	...
	public void verify_min_bulk_payment_parameter_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterMinBulkPaymentParameterDropDown(), 10, 1);
	...
	public void verify_max_bulk_payment_parameter_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterMaxBulkPaymentParameterDropDown(), 10, 1);
	...
	public void verify_foreclosure_lock_in_starts_from_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterForeClouserLockInStartsFromDropDown(), 10, 1);
	...
	public void verify_min_rebate_parameter_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterMinRebateParameterDropDown(), 10, 1);
	...
	public void verify_max_rebate_parameter_should_be_non_mendatory_user_can_able_to_select_the_data_from_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterMaxRebateParameterDropDown(), 10, 1);
	...
	public void verify_recomputation_of_profit_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterRecomputationOfProfitDropDown(), 10, 1);
	...
	public void verify_is_set_up_allowed_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterIsSetUpAllowedDropDown(), 10,
//				1);
	...
	public void verify_eligibility_type_field_should_be_non_mendatory_user_can_able_to_select_the_data_in_it()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterEligibilityTypeDropDown(), 10, 1);
	...
	public void verify_preemi_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
//		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterPreEMIDropDown(), 10,
//				1);
	...
	public void verify_is_loan_transfer_allower_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterIsLoanTransferAllowedDropDown(), 10, 1);
	...
	public void verify_user_can_able_to_save_the_scheme_master_record() throws Throwable {
		...
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMastersubmitToastAlert(), 10,
				1);
		String popup= ulsSchemeMasterObj.schemeMastersubmitToastAlert().getText();
	...
	public void verify_charge_dropdown_should_be_non_mendatory_user_can_able_to_select_the_dta_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargeChargeDropDwon(), 10, 1);
	...
	public void verify_calculation_type_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeChargeCalculationTypeDropDwon(), 10, 1);
	...
	public void verify_recpay_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesRecPayDropDown(), 10,
				1);
	...
	public void verify_recfrom_payto_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeChargesRecFrom_PayToDropDown(), 10, 1);
	...
	public void verify_include_in_cust_irr_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeChargesIncluseCustINRDropDown(), 10, 1);
	...
	public void verify_level_drop_down_should_be_non_mendatory_user_can_able_to_slect_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesLevelDropDOwn(), 10, 1);
	...
	public void verify_currency_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesCurrencyDropDOwn(), 10,
				1);
	...
	public void verify_event_field_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesEventDropDOwn(), 10, 1);
	...
	public void verify_data_unit_dropdown_should_be_non_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesDataUnitDropDOwn(), 10,
				1);
	...
	public void verify_accounting_type_field_should_be_mendatory_field_should_be_mendaory_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeChargesAccountingTypeDropDown(), 10, 1);
	...
	public void verify_stage_dropdown_field_should_be_non_mendatroy_user_can_able_to_select_the_data_from_the_drop_down()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeChargesStageDropDown(), 10, 1);
	...
	public void goto_basic_eligibility_screen() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterBasicEligibilitySegmentButton(), 10, 1);
	...
	public void goto_verification_screen() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.chemeMasterVerificationSegmentButton(), 10, 1);
	...
	public void veirfy_verification_stage_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
		...
		clicksAndActionsHelper.moveToElement(ulsSchemeMasterObj.verificationDetailsVerificationStageDropDown());
		clicksAndActionsHelper.clickOnElement(ulsSchemeMasterObj.verificationDetailsVerificationStageDropDown());
	...
	public void save_the_verification_record() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSaveButton(), 10,1);
		ulsSchemeMasterObj.schemeMasterSaveButton().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMastersubmitToastAlert(), 10,1);
		String popup=ulsSchemeMasterObj.schemeMastersubmitToastAlert().getText();
		Assert.assertTrue(popup.contains("Success"));
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterToastAlertClose(), 10,
				1);
	...
	public void verify_asset_type_field_should_be_mendatory_user_can_able_to_select_the_data_from_the_drop_down()
		 ...
		 * " ']/parent::ion-item/ion-radio"; for (int i = 0; i <= 110; i++) { try {
		 * javascriptHelper.scrollIntoView(driver.findElement(By.xpath(xpath)));
		 * clicksAndActionsHelper.moveToElement(driver.findElement(By.xpath(xpath)));
		 * clicksAndActionsHelper.clickOnElement(driver.findElement(By.xpath(xpath)));
		 * break; } catch (Exception e) { if (i == 110) { Assert.fail(e.getMessage()); }
		 * } }
		 */
		...
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.valuationDetailsAssetTypeDropDownValue(), 10, 1);
	...
	public void save_the_valuation_record() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSaveButton(), 10,
				1);
		ulsSchemeMasterObj.schemeMasterSaveButton().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMastersubmitToastAlert(), 10,
				1);
	...
	public void click_on_notification_in_schememaster_module() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterMailBox(), 10, 2);
	...
	public void select_the_record_from_the_notification_list() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterinboxSearch(), 10, 1);
		ulsSchemeMasterObj.schemeMasterinboxSearch().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSearchTextBoxInbox(), 10,
				1);
		...
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterreferenceID(), 10, 1);
		...
		excelData.updateTestData("AT-SM-T001_D1", "Reference ID", referenceID);

		// waitHelper.waitForElementToVisibleWithFluentWait(driver,
		// ulsSchemeMasterObj.schemeMasterinboxFirstRecord(), 10, 1);
	...
	public void submit_the_record_from_the_maker_stage() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSubmitButton(), 10, 1);
		...
		for (int i = 0; i <200; i++) {
			try {
				CheckerId = ulsSchemeMasterObj.schemeMaster_MakersubmitToastAlert1().getText();
        ...
        if (CheckerId.isEmpty()) {
			Assert.fail("Checker pop not showing");
		}
		System.out.println(CheckerId);
		String Space = " ";
		...
		excelData.updateTestData("AT-SM-T001_D1", "Checker id", popupID);
		Thread.sleep(2000);
	...
	public void verify_record_is_submitted_from_the_maker_end() throws Throwable {
		...
		for (int i = 0; i <200; i++) {
			try {
				CheckerId = ulsSchemeMasterObj.schemeMastersubmitToastAlert().getText();
				System.out.println(CheckerId);
				break;
			} catch (Exception e) {
				if (i==199) {
	...
	public void login_with_checker_user() throws Throwable {
	 ...
	 @Given("^Navigate to ULS application and login as a checker for approval$")
	    public void navigate_to_uls_application_and_login_as_a_checker_for_approval() throws Throwable {
		 String kulsApplicationUrl = configFileReader.getApplicationTransactionUrl();
			driver.get(kulsApplicationUrl);
			
			schemeMasterTestData=excelData.getTestdata("AT-SM-T001_D1");
			// System.out.println(testData.get("Checker id"));
			kulsLogin.ulSApplicationLoginAsAChecker(schemeMasterTestData.get("Checker id"));
	 }
...
//				ulsSchemeMasterObj.checker_InterestRepaymentFrequencyDropDown(), 10, 1);
	...
	public void verify_checker_user_can_able_to_see_the_successfull_pop_up_after_approving_the_record_from_checker_end()
			throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.checkerConfirmationPopUp(), 10, 1);
	...
	public void click_on_reject_button_in_checker_stage() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.checkerRejectButton(), 10, 1);
	...
	public void click_on_reject_button_in_alert_pop_up() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.checkerAlertRejectButton(), 10, 1);
...
//Record REJECTED Successfully
	...
	public void click_on_return_button() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.checkerReturnButton(), 10, 1);
	...
	public void click_on_return_button_in_remark_pop_up() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.checkerAlertReturnButton(), 10, 1);
	...
	public void verify_user_can_able_to_see_the_approved_record_in_list_view() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterListViewStatus(), 10, 1);
		ulsSchemeMasterObj.schemeMasterListViewStatus().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterSearchBox(), 10, 1);
	...
	public void verify_user_can_not_able_to_see_the_rejected_record_in_list_view() throws Throwable {
		// waitHelper.waitForElementToVisibleWithFluentWait(driver,
		// ulsSchemeMasterObj.schemeMasterListViewStatus(), 10, 1);
		// ulsSchemeMasterObj.schemeMasterListViewStatus().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver, ulsSchemeMasterObj.schemeMasterTextBoxCloseButton(), 10,
				1);
	...
	public void select_the_active_data_from_the_scheme_master() throws Throwable {
		...
		ulsSchemeMasterObj.schemeMasterListViewStatus().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterSchemeChargeActiveRecord(), 10, 1);
	...
	public void select_the_active_data_from_the_eligibility_screen() throws Throwable {
		...
		ulsSchemeMasterObj.schemeMasterListViewStatus().click();
		waitHelper.waitForElementToVisibleWithFluentWait(driver,
				ulsSchemeMasterObj.schemeMasterBasicEligibilityActiveRecord(), 10, 1);
