 ...
 @FindBy(xpath = "//ion-label[text()='Floating rate master']//parent::ion-label//following-sibling::ion-buttons/ion-button[2]")
    ...
    public WebElement floatingMaster_EyeIcon() {
		return floatingMaster_EyeIcon1;
		 ...
		 @FindBy(xpath = "//ion-label[text()='Floating rate master']//parent::ion-label//following-sibling::ion-buttons/ion-button[1]")
			private WebElement floatingMaster_TempView1;
		    public WebElement floatingMaster_TempView() {
				return floatingMaster_TempView1;
	}
		    @FindBy(xpath = "(//button[@ng-reflect-text='Edit'])[1]")
		   	private WebElement floatingMaster_TempFistEditIcon1;
		       public WebElement floatingMaster_TempFistEditIcon() {
		   		return floatingMaster_TempFistEditIcon1;
		   	}
    @FindBy(xpath = "//button[@ng-reflect-icon='pi pi-plus']")
       ...
       @FindBy(xpath = "//ion-select[@aria-label='Select,  Index Rate Type *']")
          ...
          @FindBy(xpath="//ion-label[text()=' Index Rate ']//following-sibling::ion-input/input")//(xpath = "//ion-label[text()=' Index Rate ']//following-sibling::ion-input/input")
        	...
        	private WebElement floatingMaster_AlertClose1;
            public WebElement floatingMaster_AlertClose() {
        		return floatingMaster_AlertClose1;
        	}
		 ...
		 @FindBy(xpath = "//ion-icon[@ng-reflect-name='mail-unread-outline']") 
		    ...
		    public WebElement Checker_Inbox() {
		        ...
		        @FindBy(xpath = "(//td[contains(text(),' FLOAT_RATE_MST ')])[1]//preceding-sibling::td[1]//child::span") 
		        private WebElement FloatingReferanceId;
		        public WebElement FloatingReferanceId() {
		            return FloatingReferanceId;
		        } 
		        @FindBy(xpath="(//td[text()=' FLOAT_RATE_MST '])[1]//parent::tr//child::td[1]/button")
		        private WebElement firstEditIconListView;
		        public WebElement firstEditIconInListView() {
		        	return firstEditIconListView;
		        }
		        @FindBy(xpath = "(//div[@role='alert'])[2]") 
		        private WebElement Checker_Id;
		        public WebElement Checker_Id() {
		            return Checker_Id;
		        } 
		        @FindBy(xpath = "//button[@label='Approve']/span[contains(text(),'Approve')]")
				 private WebElement CheckerApproveButton1;
				 public WebElement CheckerApproveButton(){
					 return CheckerApproveButton1;
			}
				 @FindBy(xpath = "//ion-label[contains(text(),'approve')]")
				 private WebElement CheckerAlertApprove1;
				 public WebElement CheckerAlertApprove(){
					 return CheckerAlertApprove1;
			}
				 @FindBy(xpath = "//ion-row[2]/ion-col[1]/span[1]/button[1]") 
				 private WebElement CheckerFinalApprove1;
				 public WebElement CheckerFinalApprove(){
					 return CheckerFinalApprove1;
			}
				 @FindBy(xpath = "//button[@label='Reject']/span[contains(text(),'Reject')]")
				 private WebElement CheckerRejectButton1;
				 public WebElement CheckerRejectButton(){
					 return CheckerRejectButton1;
			}
				 @FindBy(xpath = "//ion-label[contains(text(),'cancel')]") 
				 private WebElement CheckerAlertReject1;
				 public WebElement CheckerAlertReject(){
					 return CheckerAlertReject1;
			}
				 @FindBy(xpath = "//ion-row[2]/ion-col[1]/span[1]/button[1]")  
				 private WebElement CheckerFinalReject1;
				 public WebElement CheckerFinalReject(){
					 return CheckerFinalReject1;
			}


				    @FindBy(xpath = "//button[@label='Return']/span[contains(text(),'Return')]") 
				 private WebElement CheckerReturnButton1;
				 public WebElement CheckerReturnButton(){
					 return CheckerReturnButton1;
			}
				 @FindBy(xpath = "//ion-label[contains(text(),'return')]") 
				 private WebElement CheckerAlertReturn1;
				 public WebElement CheckerAlertReturn(){
					 return CheckerAlertReturn1;
			}
				 @FindBy(xpath = "//ion-row[2]/ion-col[1]/span[1]/button[1]")   
				 private WebElement CheckerFinalReturn1;
				 public WebElement FinalReturn(){
					 return CheckerFinalReturn1;
			}
				 @FindBy(xpath="//div[@role='alert']")
				    ...
				    @FindBy(xpath="//ion-label[text()=' Index Rate Type ']//following-sibling::ion-select")
				    private WebElement IndexRateTypeModi1;
				    public WebElement IndexRateTypeModi() {
				    	return IndexRateTypeModi1;
				    }
