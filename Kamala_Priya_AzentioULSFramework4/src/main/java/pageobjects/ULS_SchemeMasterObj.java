...
public class ULS_SchemeMasterObj {
	...
	@FindBy(xpath="//ion-grid[2]/ion-row[1]/ion-col[22]/digital-radio-button[1]/ion-item[1]/ion-toggle[1]")//ion-toggle[@role='switch']")
...
//}
	...
	@FindBy(xpath = "//ion-label[text()='  Verification Stage ']//following-sibling::ion-select")
...
private WebElement schemeMaster_MakersubmitToastAlert;
public WebElement schemeMaster_MakersubmitToastAlert1()
{
return schemeMaster_MakersubmitToastAlert;
}
