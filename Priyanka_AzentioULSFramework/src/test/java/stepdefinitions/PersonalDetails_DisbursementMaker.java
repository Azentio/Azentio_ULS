...
public class PersonalDetails_DisbursementMaker extends BaseClass {
   ...
   //Thread.sleep(1000);   
    ...
    Assert.assertEquals(PDDMTestDataType.FirstName, firstName);
    ...
    Assert.assertEquals(PDDMTestDataType.MiddleName, middleName);
    ...
    public void verify_the_field_last_name()  {
    	...
    	Assert.assertEquals(PDDMTestDataType.LastName, lastName);
    ...
    public void verify_the_field_date_of_birth()  {
    	String dateOfBirth = javascripthelper.executeScript("return document.querySelector(\"#icon\").value").toString();
        System.out.println(dateOfBirth);
    	Assert.assertEquals(PDDMTestDataType.DateOfBirth, dateOfBirth);
    ...
    public void verify_the_field_category() {
        ...
        System.out.println(expected);
        Assert.assertEquals(PDDMTestDataType.Category, expected);
    ...
    Assert.assertEquals(PDDMTestDataType.NoOfDependents, noofDependents);
    ...
    Assert.assertEquals(PDDMTestDataType.MothersMaidenName, mothersMaidenName);
    boolean status = PDDMObj.PDDM_CustomerDetails_MothersMaidenName().getAttribute("ng-reflect-is-disabled").equalsIgnoreCase("true");
    ...
    public void verify_the_field_industry_segmentation()  {
        ...
        System.out.println(expected);
        Assert.assertEquals(PDDMTestDataType.IndustrySegmentation, expected);
