...
public class ULS_AllocationMasterSteps extends BaseClass {
	...
	public void select_the_first_record_of_temp_view_in_allocation_master_screen() throws Throwable {
		waitHelper.waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.ulsAllocationMasterTempViewFirstRecord(), 10, 1);
	...
	public void update_the_description_field_in_allocation_master() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-006_D1");
		allocationMasterObj.allocationMasterDescriptionInputBox().sendKeys(testData.get("Description"));
	}
	...
	public void update_the_allocation_code_field() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-006_D1");
		allocationMasterObj.allocationMasterAllocationCodeInputBox().sendKeys(testData.get("Allocation code"));
	}
	...
	public void search_the_allocation_module_event_code() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-006_D1");
		ulsCommonWebElement.ulsNotificationSearchTextBox().sendKeys(testData.get("Search"));
	}
	...
	public void enter_the_alert_remark_in_allocation_master_record() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-006_D1");
		ulsCommonWebElement.ulsAlertRemark().sendKeys(testData.get("Remark"));
	}
	...
	public void get_the_checker_id_for_allocation_master_record() throws Throwable {
		...
		exceldata.updateTestData("AT-ALM-006_D1", "Checker id", finalCheckerID);
	...
	public void enter_the_special_character_input_in_description_field() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-008_D1");
		allocationMasterObj.allocationMasterDescriptionInputBox().sendKeys(testData.get("SpecialCharacterInput"));
	...
	public void enter_the_special_character_input_in_allocation_code_field() throws Throwable {
		...
		testData = exceldata.getTestdata("AT-ALM-008_D1");
		allocationMasterObj.allocationMasterAllocationCodeInputBox().sendKeys(testData.get("SpecialCharacterInput"));
	}
