...
public class KULS_CustomerEntityLayout_FacilityDetails {
    ...
    public void user_get_the_values_in_the_saved_record_in_customer_entity_layout_facility_details() throws Throwable {
    	...
    	help.waitForElementToVisibleWithFluentWait(driver, Transaction.FacilityDetails_RequestedAmount2(), 60, 5);
    	RequestedAmount = Transaction.FacilityDetails_RequestedAmount2().getAttribute("ng-reflect-model");
    	System.out.println("RequestedAmount " +RequestedAmount);
    	
    	help.waitForElementToVisibleWithFluentWait(driver, Transaction.FacilityDetails_LoanTenure2(), 60, 5);
    	LoanTenure = Transaction.FacilityDetails_LoanTenure2().getAttribute("ng-reflect-model");
    ...
    public void user_click_the_update_icon_in_customer_entity_layout_facility_details() throws Throwable {
    	
    	help.waitForElementToVisibleWithFluentWait(driver, Transaction.update(), 60, 5);
    	Transaction.update().click();
