...
public class KULS_CollateralSubType_Step {
   ...
   ExcelData exceldata = new ExcelData("C:\\Users\\inindc00075\\Downloads\\UlsTestDataDesign.xlsx", "CollateralSubTypeTestData", "Data Set ID") ;
	 ...
	 @Given("^Launch the kuls application and Navigate to collateral subtype module view list$")
	    public void launch_the_kuls_application_and_navigate_to_collateral_subtype_module_view_list() throws Throwable {
		 String kulsApplicationUrl = configFileReader.getApplicationUrl();
		    ...
		    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.ConfigManagerInLeftPanel(),30,2);
	    ...
	    public void click_on_save_button_in_collateral_subtype() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeSaveIcon(),30,2);
	        ...
	        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.closeIconInSuccessPopupOfCollateralSubType(),30,2);
	    ...
	    public void click_on_add_icon_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeAddIcon(),30,2);
	    ...
	    public void enter_the_value_in_description_field_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeDescriptionField(),30,2);
	    ...
	    public void enter_the_value_in_assetcollateralsubtypecode_field() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(testdata.get("Asset/Collateral subtype code"));
	    ...
	    public void select_the_value_in_assetcollateraltype_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.CollateralSubTypeCollateralTypeField(), 30, 2);
	    ...
	    public void enter_the_value_in_exposure_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeExposurePercentageField(),30,2);
	    	for (int i = 0; i < 30; i++) {
				try {
	    ...
	    public void enter_the_value_in_assetcollateralvaluationtolerance_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField(),30,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField().sendKeys(testdata.get("Asset/Collateral Valuation Tollerance"));
	    ...
	    public void enter_the_value_in_remarks_field_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeRemarksField(),30,2);
	    ...
	    public void user_capture_checker_id_from_the_submit_popup() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAuto_Checker_Id(),30, 3);
	       ...
	       // json.addData(popupID);
	        exceldata.updateTestData("AT-ACS-T006_D6", "Checker id", popupID);
	    ...
	    public void verify_the_record_approved_popup_for_collateral_sub_type() throws Throwable {
	    	String Toast;
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.checkerApproveMgs(), 30, 2);
	    ...
	    public void submit_the_collateral_sub_type_record_from_maker_user() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.assetAutoMaker_Submit(), 30, 2);
	    ...
	    public void search_the_collateral_sub_type_record() throws Throwable {
            ...
            seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAutoInboxView_SearchText(),30,2);
	    ...
	    public void store_the_reference_number_and_click_on_first_collateral_subtype_record() throws Throwable {
	       ...
	       // json.addReferanceData(reference);
	        exceldata.updateTestData("AT-ACS-T006_D6", "Reference ID", reference);
	    ...
	    public void click_on_remarks_button_action_confirmation_popup_for_collateral_sub_type_rejection() throws Throwable{
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Final_Reject(), 30, 2);
	    ...
	    public void click_on_reject_button_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Reject(), 30, 2);
	    ...
	    public void enter_the_remarks_in_action_confirmation_popup_for_collateral_sub_type_rejection() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Alert_Reject(), 30, 2);	   
	    ...
	    public void click_on_remarks_button_action_confirmation_popup_for_collateral_sub_type_return() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Final_Return(), 30, 2);
	    ...
	    public void click_on_return_button_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Return(), 30, 2);
	    ...
	    public void enter_the_remarks_in_action_confirmation_popup_for_collateral_sub_type_return() throws Throwable  {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Alert_Return(), 30, 2);
	    ...
	    public void navigate_to_temp_view_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.TempViewIconOfCollateralSubType(),30,2);
	    ...
	    public void click_on_save_button_and_validate_the_field_is_required_popup() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeSaveIcon(),30,2);
	    	collateralsubtypeObj.CollateralSubTypeSaveIcon().click();
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.requiredFieldWarningPopup(),30,2);
	    ...
	    public void click_on_back_button_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeBackIcon(),30,2);
	    ...
	    public void enter_special_characters_in_all_fields_and_validate_the_popup() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(testdata.get("Asset/Collateral subtype code"));
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.alphaNumericCharactersAllowedWarningPopup(),30,2);
	    ...
	    public void select_the_existing_record_in_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.pencilIconOfFirstRecordInCollateralSubType(),30,2);
	    ...
	    public void update_the_value_in_assetcollateraltype_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.CollateralSubTypeCollateralTypeFieldForUpdate(), 30, 2);
	    ...
	    public void update_the_status_of_collateral_sub_type_record() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.statusToggleIconOfCollateralSubtype(),30,2);
	    ...
	    public void validat_the_export_to_pdf_functionality_of_collateral_sub_type() throws Throwable {
            ...
            seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.exportToPDFOfCollateralSubType(),30,3);
	    ...
	    public void validate_the_view_summary_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.viewSummaryIconOfCollateralSubType(),30,2);
	    	
					seleniumactions.getJavascriptHelper().JSEClick(collateralsubtypeObj.viewSummaryIconOfCollateralSubType());
					
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.viewSummaryPageOfCollateralSubType(),30,2);
	    ...
	    public void validate_the_fields_present_in_collateral_sub_type_view_list() throws Throwable {
	    	...
	    	String xpath ="(//span[contains(text(),'Action')])[1]";
	         ...
	         seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,driver.findElement(By.xpath(xpath2)),30,2);
	     	WebElement description = driver.findElement(By.xpath(xpath2));
	     	System.out.println(description);
	     	String xpath3 ="(//span[contains(text(),' Status ')])[1]";
	         seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,driver.findElement(By.xpath(xpath3)),30,2);
	    ...
	    public void validate_the_fields_in_wip_of_collateral_sub_type() throws Throwable {
	    	String xpath ="(//span[contains(text(),'Action')])[1]";
	         ...
	         seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,driver.findElement(By.xpath(xpath4)),30,2);
	    ...
	    public void update_the_value_in_assetcollateralsubtypecode_field_for_checker_approve() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField(),1,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().clear();
