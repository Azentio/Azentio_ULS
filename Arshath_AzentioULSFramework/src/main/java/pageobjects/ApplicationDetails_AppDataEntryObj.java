...
public class ApplicationDetails_AppDataEntryObj {
	...
	@FindBy(xpath="//ion-label[text()=' Total Finance Amount Requested ']/parent::div/following-sibling::div//child::p-inputnumber")
	private WebElement AppDataEntry_TotalFinanceAmountRequestedField_validation;
	public WebElement AppDataEntry_TotalFinanceAmountRequestedField_validation() {
		return AppDataEntry_TotalFinanceAmountRequestedField_validation;
	}
