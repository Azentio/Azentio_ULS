...
public class LivingExpenseObj {
	...
	@FindBy(xpath="//ion-label[text()='Living Expense Location']/parent::ion-segment-button")
	...
	private WebElement LivingExpenseparameterButton;
	public WebElement LivingExpenseparameterButton() {
		return LivingExpenseparameterButton;
	}
