...
public class Transactions_ScreenOBJ {
	...
	@FindBy(xpath="//ion-label[contains(text(),'Requested Amount')]//parent::div//following-sibling::div//p-inputnumber")
	private WebElement FacilityDetails_RequestedAmount2;
	public WebElement FacilityDetails_RequestedAmount2()
	{
		return FacilityDetails_RequestedAmount2;
	...
	public WebElement NewSave()
	{
		return NewSave;
			...
			@FindBy(xpath="//button[@ng-reflect-text='Update']//child::span")
