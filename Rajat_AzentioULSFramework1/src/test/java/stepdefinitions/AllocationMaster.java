...
public class AllocationMaster {
    ...
    AllocationMasterObj allocationMasterObj = new AllocationMasterObj(driver);
    AllocationMasterTestdata  allocationMasterTestData= jsonConfig.getAllocationMaster1ListByName("Maker");
    ...
    public void user_click_the_configuration_menu_for_allocation_master() throws Throwable {
    	...
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.configurationOptions(),30, 2);
    ...
    public void user_click_first_edit_icon_in_approved_list_view_for_allocation_master() throws Throwable {
    	//seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.firstEditIcon(),30, 2);
    	for (int i = 0; i <30; i++) {
			try {
    ...
    public void user_click_and_update_description() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.AllocationMaster_DescriptionTextBox(),30, 2);
    ...
    public void user_click_and_update_allocation_code() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.AllocationMaster_AllocationCodeTextBox(),30, 2);
    ...
    public void user_click_save_button_for_allocation_master_updation() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.alloctiont_Master_Update(),30, 2);
    ...
    public void user_click_inbox_to_approve_record_for_allocation_master() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.Inbox(),30, 2);
    ...
    public void user_search_allocation_master() throws Throwable {
    	...
    	for (int i = 0; i <20; i++) {
            ...
            seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.InboxView_SearchText(),60,2);
    ...
    public void user_store_reference_number_and_click_the_first_record_in_allocation_master_inbox_view() throws Throwable {
        ...
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.firstEditIconInMakerListView(),40, 2);
    ...
    public void user_submit_allocation_master_record_in_maker() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWaitElementToBeClickable(driver, allocationMasterObj.allocationMasterMaker_Submit(), 60, 2);
    	allocationMasterObj.allocationMasterMaker_Submit().click();
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.allocationMasterMaker_EnterRemark(),30,2);
        ...
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.allocationMasterMaker_RemarkSubmit(),30, 2);
    ...
    public void user_click_on_return_button_in_action_confirmation_popup_for_allocation_master_record() throws Throwable {
    	for (int i = 0; i <30; i++) {
			try {
    ...
    public void user_verify_the_record_got_returned_for_allocation_master_record() throws Throwable {
    	String Toast;
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, allocationMasterObj.checkerApproveMgs(), 60, 2);
    ...
    public void user_click_on_mailbox_icon_for_allocation_master_record() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.Checker_Inbox(), 30, 2);
    ...
    public void search_the_respective_reference_id_and_click_on_action_button_for_allocation_master_record() throws Throwable {
    	for (int i = 0; i <20; i++) {
			try {
    ...
    public void user_click_on_return_icon_for_allocation_master_record() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,allocationMasterObj.Checker_Return(), 30, 2);
    ...
    public void search_the_respective_reference_id_and_verify_record_should_returned_to_maker() throws Throwable {
    	for (int i = 0; i <20; i++) {
			try {
				Assert.assertEquals(true, driver.findElement(By.xpath("//span[text()='" + json.readReferancedata() + "']/ancestor::tr/td[1]/button")).isDisplayed());
				break;
