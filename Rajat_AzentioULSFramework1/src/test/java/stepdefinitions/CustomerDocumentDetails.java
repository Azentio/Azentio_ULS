...
import resources.RadioButtonHelper;
...
public class CustomerDocumentDetails {
	...
	CustomerDocumentDetailsTestDataType documentDetailsTestDataType = jsonConfig
			.getCustomerDocumentDetailsByName("Maker");
	...
	public void enter_the_reference_id_of_the_Customer_Document_Details_record() throws Throwable {
		waithelper.waitForElementwithFluentwait(driver,
				documentDetailsObj.customerDocumentDetails_SearchInboxInputField());
		documentDetailsObj.customerDocumentDetails_SearchInboxInputField()
				.sendKeys(documentDetailsTestDataType.ReferenceID);

	}

	@Then("^click on the entitle button of the Customer Document Details record of that reference id$")
	public void click_on_the_entitle_button_of_the_Customer_Document_Details_record_of_that_reference_id()
			throws Throwable {
		...
		while (true) {
			try {
				driver.findElement(By.xpath(beforexpath + jsonDataReaderWriter.readReferancedata() + afterxpath))
						.click();
				break;
			} catch (Exception e) {
	...
	public void open_the_record_of_Customer_Document_Details_to_modify() throws Throwable {
		...
		Thread.sleep(500);
		waithelper.waitForElementwithFluentwait(driver,
				driver.findElement(By.xpath(beforexpath + documentDetailsTestDataType.Number + afterxpath)));
	...
	public void verify_system_should_allow_user_to_do_a_modification_of_Customer_Document_Details_record_before_approved()
			throws Throwable {
		...
		Thread.sleep(500);
		waithelper.waitForElementwithFluentwait(driver,
				documentDetailsObj.customerDocumentDetails_MandatoryOrOptional());
	...
	public void verify_system_display_the_confirmation_message_post_clicking_on_save_button_of_Customer_Document_Details_record()
			throws Throwable {
		waithelper.waitForElementwithFluentwait(driver,
				documentDetailsObj.customerDocumentDetails_SaveConfirmationMessage());
	...
	public void verify_the_same_record_of_customer_document_details_should_get_saved_in_a_system() throws Throwable {
		...
		waithelper.waitForElementwithFluentwait(driver,
				driver.findElement(By.xpath(beforexpath + documentDetailsTestDataType.Number + afterxpath)));
		boolean status = driver.findElement(By.xpath(beforexpath + documentDetailsTestDataType.Number + afterxpath))
				.isDisplayed();
		Assert.assertTrue(status);
	}
	...
	public void verify_system_should_display_the_mention_fields_on_list_view_of_customer_documents_details()
			throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, documentDetailsObj.customerDocumentDetails_AddButton());
	...
	public void verify_values_in_list_view_of_customer_documents_details_should_be_non_editable() throws Throwable {
		try {
			documentDetailsObj.customerDocumentDetails_ListViewNumberValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewDocumentNameValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewRequiredAtStageValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewDocumentStatusValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewMandatoryOrOptionalValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewDocumentCategoryValue()
					.sendKeys(documentDetailsTestDataType.EditText);
		...
		try {
			documentDetailsObj.customerDocumentDetails_ListViewDMSUploadStatusValue()
					.sendKeys(documentDetailsTestDataType.EditText);
	...
	public void verify_search_box_should_display_matching_record_with_matched_data_of_customer_documents_details()
			throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, documentDetailsObj.customerDocumentDetails_SearchButton());
		documentDetailsObj.customerDocumentDetails_SearchButton().click();
		Thread.sleep(1000);
	...
	public void verify_search_box_should_not_display_any_record_with_mismatched_data_of_customer_documents_details()
			throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, documentDetailsObj.customerDocumentDetails_SearchButton());
		documentDetailsObj.customerDocumentDetails_SearchButton().click();
		Thread.sleep(1000);
		documentDetailsObj.customerDocumentDetails_SearchInputField()
				.sendKeys(documentDetailsTestDataType.InvalidInput);
		Thread.sleep(500);
	...
	public void click_on_export_to_excel_button_system_should_download_excel_file_of_customer_documents_details()
			throws Throwable {
		for (int i = 0; i < 20; i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver,
						documentDetailsObj.customerDocumentDetails_ExportButton());
				documentDetailsObj.customerDocumentDetails_ExportButton().click();
				break;
			} catch (Exception e) {
				// TODO: handle exception
	...
	public void click_on_export_to_pdf_button_system_should_download_pdf_file_of_customer_documents_details()
			throws Throwable {
		for (int i = 0; i < 20; i++) {
			try {
				waithelper.waitForElementwithFluentwait(driver,
		...
		while (true) {
			try {
				waithelper.waitForElementwithFluentwait(driver,
						documentDetailsObj.customerDocumentDetails_ExportToPDF());
	...
	public void verify_the_functionality_of_add_button_of_customer_documents_details_list_view_screen()
			throws Throwable {
		waithelper.waitForElementwithFluentwait(driver, documentDetailsObj.customerDocumentDetails_AddButton());
		documentDetailsObj.customerDocumentDetails_AddButton().click();
		waithelper.waitForElementwithFluentwait(driver, documentDetailsObj.customerDocumentDetails_BackButton());
