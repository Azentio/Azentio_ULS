...
public class ULS_DrawdownDetailsObj {
	...
	private WebElement drawdownIcon;
	public WebElement drawdownIcon()
	{
		return drawdownIcon;
	}
	@FindBy(xpath="(//ion-title[contains(text(),' Payment Details ')]/ancestor::ion-row[3]//following-sibling::ion-button)[2]")
	private WebElement paymentDetails_AddIcon;
	public WebElement paymentDetails_AddIcon()
	{
		return paymentDetails_AddIcon;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Payment Type ')]//following-sibling::ion-select")
	private WebElement paymentDetails_PaymentTypeField;
	public WebElement paymentDetails_PaymentTypeField()
	{
		return paymentDetails_PaymentTypeField;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Payee ')]//following-sibling::ion-input/input")
	private WebElement paymentDetails_PayeeField;
	public WebElement paymentDetails_PayeeField()
	{
		return paymentDetails_PayeeField;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Planned Schedule Disbursement Balance ')]//following-sibling::ion-input/input")
	private WebElement paymentDetails_PlannedScheduledDisbursementBalanceField;
	public WebElement paymentDetails_PlannedScheduledDisbursementBalanceField()
	{
		return paymentDetails_PlannedScheduledDisbursementBalanceField;
	}
	@FindBy(xpath="//ion-label[contains(text(),' Schdeule amount ')]//following-sibling::ion-input/input")
	private WebElement paymentDetails_ScheduleAmountField;
	public WebElement paymentDetails_ScheduleAmountField()
	{
		return paymentDetails_ScheduleAmountField;
	}
	@FindBy(xpath="//button[text()='Save ']")
	private WebElement PaymentDetails_SaveButton;
	public WebElement PaymentDetails_SaveButton()
	{
		return PaymentDetails_SaveButton;
	}
    ...
    @FindBy(xpath = "//td[contains(text(),' DISBMKR ')]/parent::tr/td/button[1]") 
    private WebElement ApplicationDetailsMailBoxActionButtonOfFirstRecord_DISBMKR;
    public WebElement ApplicationDetailsMailBoxActionButtonOfFirstRecord_DISBMKR() {
    return ApplicationDetailsMailBoxActionButtonOfFirstRecord_DISBMKR;
    }
}
