...
public class OfferDetailsObj {
	...
	// Offer Details Section
		...
		// Offer Details Section Product
			    ...
			    @FindBy(xpath = "(//ion-icon[@ng-reflect-name='arrow-back-outline'])[2]") 
			    private WebElement OfferDetails_BackIcon;
			    public WebElement OfferDetails_BackIcon() {
			    return OfferDetails_BackIcon;
			    } 
