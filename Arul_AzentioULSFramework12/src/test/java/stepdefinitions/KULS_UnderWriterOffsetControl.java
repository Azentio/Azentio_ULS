...
public class KULS_UnderWriterOffsetControl {
	...
	KULS_CollateralSubType underwriteroffsetcontrolData = jsonConfig.getCollateralSubTypeByName("Maker");
   JsonDataReaderWriter json = new JsonDataReaderWriter();
    ...
    public void launch_the_kuls_application_and_navigate_to_under_writer_offset_control_view_list() throws Throwable {
	    ...
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.configurationInLeftPanel(),60,2);
	    underwriteroffsetcontrolObj.configurationInLeftPanel().click();
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.businessRulesInLeftPanel(),60,2);
	    underwriteroffsetcontrolObj.businessRulesInLeftPanel().click();
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.ViewIconOfListViewInUnderWriterOffsetControl(),60,2);
    ...
    public void validate_the_functionality_of_view_summary_section_in_under_writer_offset_control() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.viewSummaryIconOfUnderWriterOffsetControl(),60,2);
    	
		seleniumactions.getJavascriptHelper().JSEClick(underwriteroffsetcontrolObj.viewSummaryIconOfUnderWriterOffsetControl());
		
seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.viewSummaryPageOfUnderWriterOffsetControl(),60,2);
Assert.assertEquals(underwriteroffsetcontrolObj.viewSummaryPageOfUnderWriterOffsetControl().isDisplayed(), true);
    }
    ...
    public void validate_the_functionalitiy_of_add_button_of_under_writer_offset_control() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.UnderWriterOffsetControlAddIcon(),60,2);
    ...
    public void click_on_back_icon_of_under_writer_offset_control() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.underwriteroffsetcontrolBackIcon(),60,2);
    ...
    public void verify_that_user_can_click_on_view_inprogress_in_view_list_of_under_writer_offset_control() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.pencilIconOfFirstRecordInUnderWriterOffsetControl(),60,2);
    	underwriteroffsetcontrolObj.pencilIconOfFirstRecordInUnderWriterOffsetControl().click();
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.underwriteroffsetcontrolMinimumValueField(),60,2);
    	Assert.assertEquals(underwriteroffsetcontrolObj.underwriteroffsetcontrolMinimumValueField().isDisplayed(), true);
    }
    ...
    public void search_with_valid_data_in_under_writer_offset_control() throws Throwable {
    	...
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.searchTextFieldOfUnderWriterOffsetControl(),30,2);
    ...
    public void validate_export_to_pdf_functionality_of_under_writer_offset_control() throws Throwable {
        ...
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.exportToPDFOfUnderWriterOffsetControl(),60,3);
    ...
    public void navigate_to_temp_view_of_under_writer_offset_control() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,underwriteroffsetcontrolObj.TempViewIconOfUnderWriterOffsetControl(),60,2);
