...
public class BeneficiaryDetailsStep {
	...
	KULS_CustomerEntityLayout_ContactDetails_Testdata beneficiarydetaildata = jsonConfig.getContactDetailsByName("Maker");
    ...
    public void navigate_to_mail_box_of_application_details_and_search_the_disbckr_value() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.ApplicationDetails_Inbox(), 30, 2);
        ...
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.ApplicationDetailsInboxView_SearchText(),60,2);
    ...
    public void click_on_action_icon_of_first_record_of_application_detailsdisbmkr() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.ActionButtonOfFirstRecord_DISBMKR(), 30, 2);
    ...
    public void navigate_to_beneficiary_details_section() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.BeneficiaryDetailsSection(), 60, 2);
    	for (int i = 0; i <20; i++) {
			try {
    ...
    public void remove_values_from_required_fields_in_beneficiary_details() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.Beneficiaryname(), 60, 2);
    ...
    public void click_on_save_button_and_validate_field_is_required_popup_in_beneficiary_details() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.ContactDetails_SaveIcon(),60,2);
    	beneficiarydetailsobj.ContactDetails_SaveIcon().click();
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.requiredFieldWarningPopup(),60,2);
    ...
    public void update_with_invalid_data_and_validate_error_popup_in_beneficiary_details() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.BeneficiaryKYC(),60,2);
    	...
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.alphaNumericCharactersAllowedWarningPopup(),60,2);
    ...
    public void click_on_pencil_icon_of_existing_beneficiary_details_record() throws Throwable {
    	Thread.sleep(2000);
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.BeneficieryDetails_PencilIconOfFirstRecord(), 60, 2);
    ...
    public void click_on_back_button_of_beneficiary_details() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,beneficiarydetailsobj.BackIcon(),60,2);
