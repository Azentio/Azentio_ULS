...
//	PersonalDetails_DisbursementMakerTestDataType PDDMTestDataType = jsonReader.getPersonalDetails_DisbursementMakerByName("Maker");
	...
	ExcelData excelData = new ExcelData("C:\\Users\\inindc00074\\Downloads\\UlsTestDataDesign0612d.xlsx",
			"PDDMTestData", "Data Set ID");
	...
	public void verify_the_field_customer_type() throws InterruptedException {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[3].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_CustomerType().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_applicant_type() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[4].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_ApplicantType().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_salutation() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[5].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_Salutation().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_first_name() throws InterruptedException {
		...
		String firstNameExpected = javascripthelper
				.executeScript("return document.getElementsByClassName('native-input sc-ion-input-ios')[1].value")
				.toString();
		...
		boolean result = PDDMObj.PDDM_CustomerDetails_FirstName().getAttribute("ng-reflect-is-disabled")
	...
	public void verify_the_field_middle_name() {
		String middleNameExpected = javascripthelper
				.executeScript("return document.getElementsByClassName('native-input sc-ion-input-ios')[2].value")
				.toString();
		testData = excelData.getTestdata("AT-PDM-001_D1");
		String middleName = testData.get("Middle Name");
		Assert.assertEquals(middleName, middleNameExpected);
		boolean result = PDDMObj.PDDM_CustomerDetails_MiddleName().getAttribute("ng-reflect-is-disabled")
				.equalsIgnoreCase("true");
	...
	public void verify_the_field_last_name() {
		...
		String lastNameExpected = javascripthelper
				.executeScript("return document.getElementsByClassName('native-input sc-ion-input-ios')[3].value")
				.toString();
		testData = excelData.getTestdata("AT-PDM-001_D1");
		String lastName = testData.get("Last Name");
		Assert.assertEquals(lastName, lastNameExpected);
		boolean result = PDDMObj.PDDM_CustomerDetails_LastName().getAttribute("ng-reflect-is-disabled")
				.equalsIgnoreCase("true");
	...
	public void verify_the_field_date_of_birth() {
		String dateOfBirthExpected = javascripthelper.executeScript("return document.querySelector(\"#icon\").value")
				.toString();
		...
		boolean result = PDDMObj.PDDM_CustomerDetails_DateOfBirth().getAttribute("ng-reflect-is-disabled")
				.equalsIgnoreCase("true");
	...
	public void verify_the_field_gender() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[7].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
	...
	public void verify_the_field_edcuation_level() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[8].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_EdcuationLevel().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_marital_status() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[9].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_MaritalStatus().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_nationality() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[10].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		...
		boolean status = PDDMObj.PDDM_CustomerDetails_Nationality().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_category() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[11].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
	...
	public void verify_the_field_religion() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[12].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
	...
	public void verify_the_field_resident_status() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[13].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		Assert.assertEquals(testData.get("Resident Status"), expected);

		boolean status = PDDMObj.PDDM_CustomerDetails_ResidentStatus().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_language() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[14].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
	...
	public void verify_the_field_no_of_dependents() {
		String noofDependents = javascripthelper
				.executeScript("return document.getElementsByClassName('native-input sc-ion-input-ios')[11].value")
				.toString();
		testData = excelData.getTestdata("AT-PDM-001_D1");
		Assert.assertEquals(testData.get("No of Dependents"), noofDependents);
		boolean status = PDDMObj.PDDM_CustomerDetails_MothersMaidenName().getAttribute("ng-reflect-is-disabled")
				.equalsIgnoreCase("true");
	...
	public void verify_the_field_mothers_maiden_name() {
		String mothersMaidenName = javascripthelper
				.executeScript("return document.getElementsByClassName('native-input sc-ion-input-ios')[12].value")
				.toString();
		testData = excelData.getTestdata("AT-PDM-001_D1");
	...
	public void verify_the_field_type_of_residence() {
		...
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[15].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		Assert.assertEquals(testData.get("Type of Residence"), expected);

		boolean status = PDDMObj.PDDM_CustomerDetails_TypeOfResidence().getAttribute("ng-reflect-is-disabled")
				.equals("true");
	...
	public void verify_the_field_industry_segmentation() {
		waithelper.waitForElementToVisibleWithFluentWait(driver, PDDMObj.PDDM_CustomerDetails_IndustrySegmentation(),
				10, 1);
		String expected = javascripthelper.executeScript(
				"return document.querySelectorAll('ion-select')[16].shadowRoot.querySelector('div.select-text').innerText")
				.toString();
		System.out.println(expected);
		testData = excelData.getTestdata("AT-PDM-001_D1");
		Assert.assertEquals(testData.get("Industry Segmentation"), expected);

		boolean status = PDDMObj.PDDM_CustomerDetails_IndustrySegmentation().getAttribute("ng-reflect-is-disabled")
				.equals("true");
...
//        PDDMObj.PDDM_CustomerDetails_BackButton().isDisplayed();
	...
	public void clicking_on_back_button_system_should_navigate_to_the_previous_screen() {
		waithelper.waitForElementToVisibleWithFluentWait(driver, PDDMObj.PDDM_CustomerDetails_ListView_BackButton(), 10,
				1);
...
//    	String customerType = testData.get("Customer Type");
		...
		try {
			...
			waithelper.waitForElementToVisibleWithFluentWait(driver,
					PDDMObj.PDDM_CustomerDetails_CustomerTypeDropdown(), 10, 1);
...
//			Assert.assertTrue(false);
				...
				if (i == 100) {
					...
					Assert.fail("add button not present");
				}
			}
	...
	public void click_on_the_first_record_from_mail_box() throws Throwable {
		Thread.sleep(2000);
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,
				PDDMObj.ActionButtonOfFirstRecordInMailBox(), 30, 2);
		PDDMObj.ActionButtonOfFirstRecordInMailBox().click();
	}
