	 ...
	 @Given("^Launch the kuls application and Navigate to collateral subtype module view list$")
	    public void launch_the_kuls_application_and_navigate_to_collateral_subtype_module_view_list() throws Throwable {
		 String kulsApplicationUrl = configFileReader.getApplicationUrl();
		    ...
		    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.configurationInLeftPanel(),60,2);
		    collateralsubtypeObj.configurationInLeftPanel().click();
		    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.AssetCollateralConfigInLeftPanel(),60,2);
		    collateralsubtypeObj.AssetCollateralConfigInLeftPanel().click();
		    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.ViewIconOfCollateralSubType(),60,2);
	    ...
	    public void click_on_save_button_in_collateral_subtype() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeSaveIcon(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeSaveIcon().click();
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypesubmitSuccessPopup(),60,2);
	        Assert.assertEquals(collateralsubtypeObj.CollateralSubTypesubmitSuccessPopup().isDisplayed(), true);	       
	        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.closeIconInSuccessPopupOfCollateralSubType(),60,2);
	    ...
	    public void click_on_add_icon_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeAddIcon(),60,2);
	    ...
	    public void enter_the_value_in_description_field_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeDescriptionField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeDescriptionField().click();
	    	collateralsubtypeObj.CollateralSubTypeDescriptionField().sendKeys(collateralsubtypeData.Description);
	    ...
	    public void enter_the_value_in_assetcollateralsubtypecode_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.Asset_CollateralSubtypeCode);
	    ...
	    public void select_the_value_in_assetcollateraltype_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.CollateralSubTypeCollateralTypeField(), 60, 2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralTypeField().click();
			for (int i = 0; i < 50; i++) {
				try {
						driver.findElement(By.xpath("//ion-label[contains(text(),'" + collateralsubtypeData.Asset_CollateralType
	    ...
	    public void enter_the_value_in_exposure_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeExposurePercentageField(),60,2);
	    	for (int i = 0; i < 50; i++) {
				try {
					collateralsubtypeObj.CollateralSubTypeExposurePercentageField().click();
					collateralsubtypeObj.CollateralSubTypeExposurePercentageField().sendKeys(collateralsubtypeData.Exposure);
						break;
					} catch (Exception e) {
					}
				}
	    ...
	    public void enter_the_value_in_assetcollateralvaluationtolerance_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField().sendKeys(collateralsubtypeData.Asset_CollateralValuationTolerance);
	    ...
	    public void enter_the_value_in_remarks_field_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeRemarksField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeRemarksField().click();
	    	collateralsubtypeObj.CollateralSubTypeRemarksField().sendKeys(collateralsubtypeData.Remarks);
	    ...
	    public void user_capture_checker_id_from_the_submit_popup() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAuto_Checker_Id(),60, 3);
	    ...
	    public void verify_the_record_approved_popup_for_collateral_sub_type() throws Throwable {
	    	String Toast;
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.checkerApproveMgs(), 60, 2);
	    ...
	    public void search_the_respective_reference_id_and_click_on_action_button_for_collatral_sub_type() throws Throwable {
	    	for (int i = 0; i <20; i++) {
				try {
	    ...
	    public void click_on_approve_button_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.Checker_Approve(), 30, 2);
	    ...
	    public void click_on_remarks_button_in_action_confirmation_popup_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.Checker_Final_Approve(), 30, 2);
	    ...
	    public void click_on_mail_icon_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.Checker_Inbox(), 30, 2);
	    ...
	    public void submit_the_collateral_sub_type_record_from_maker_user() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.assetAutoMaker_Submit(), 60, 2);
	    	collateralsubtypeObj.assetAutoMaker_Submit().click();
	        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAutoMakerMaker_EnterRemark(),30,2);
	        ...
	        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAutomakerRemarkSubmit(),30, 2);
	    ...
	    public void search_the_collateral_sub_type_record() throws Throwable {
            ...
            seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.assetAutoInboxView_SearchText(),60,2);
            collateralsubtypeObj.assetAutoInboxView_SearchText().click();
            collateralsubtypeObj.assetAutoInboxView_SearchText().sendKeys(collateralsubtypeData.SearchAssetAuto);
	    }
	    ...
	    public void click_on_remarks_button_action_confirmation_popup_for_collateral_sub_type_rejection() throws Throwable{
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Final_Reject(), 60, 2);
	    ...
	    public void click_on_reject_button_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Reject(), 60, 2);
	    ...
	    public void enter_the_remarks_in_action_confirmation_popup_for_collateral_sub_type_rejection() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Alert_Reject(), 60, 2);	   
	    ...
	    public void click_on_remarks_button_action_confirmation_popup_for_collateral_sub_type_return() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Final_Return(), 60, 2);
	    ...
	    public void click_on_return_button_for_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Return(), 60, 2);
	    ...
	    public void enter_the_remarks_in_action_confirmation_popup_for_collateral_sub_type_return() throws Throwable  {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.Checker_Alert_Return(), 60, 2);
	    ...
	    public void navigate_to_temp_view_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.TempViewIconOfCollateralSubType(),60,2);
	    ...
	    public void enter_the_value_in_assetcollateralsubtypecode_field_for_checker_return() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.Asset_CollateralSubtypeCodeForReturn);
	    }
	    ...
	    public void click_on_save_button_and_validate_the_field_is_required_popup() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeSaveIcon(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeSaveIcon().click();
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.requiredFieldWarningPopup(),60,2);
	    ...
	    public void click_on_back_button_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeBackIcon(),60,2);
	    ...
	    public void enter_special_characters_in_all_fields_and_validate_the_popup() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeDescriptionField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeDescriptionField().click();
	    	collateralsubtypeObj.CollateralSubTypeDescriptionField().sendKeys("####");
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField(),60,2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys("####");
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.alphaNumericCharactersAllowedWarningPopup(),60,2);
	    ...
	    public void select_the_existing_record_in_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.pencilIconOfFirstRecordInCollateralSubType(),60,2);
	    ...
	    public void update_the_value_in_description_field_of_collateral_sub_type() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeDescriptionField().sendKeys(collateralsubtypeData.UpdatedDescription);
	    }
	    ...
	    public void update_the_value_in_assetcollateralsubtypecode_field() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.UpdatedAsset_CollateralSubtypeCode);
	    }
	    ...
	    public void update_the_value_in_assetcollateraltype_field() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, collateralsubtypeObj.CollateralSubTypeCollateralTypeFieldForUpdate(), 60, 2);
	    	collateralsubtypeObj.CollateralSubTypeCollateralTypeFieldForUpdate().click();
			for (int i = 0; i < 50; i++) {
				try {
						driver.findElement(By.xpath("//ion-label[contains(text(),'" + collateralsubtypeData.UpdatedAsset_CollateralType
								+ "')]/following-sibling::ion-radio")).click();
						break;
					} catch (Exception e) {
					}
	    ...
	    public void update_the_value_in_exposure_field() throws Throwable {
	    	for (int i = 0; i < 50; i++) {
				try {
					...
					collateralsubtypeObj.CollateralSubTypeExposurePercentageField().sendKeys(collateralsubtypeData.updatedExposure);
						break;
					} catch (Exception e) {
					}
				}
	    ...
	    public void update_the_value_in_assetcollateralvaluationtolerance_field() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeCollateralValuationToleranceField().sendKeys(collateralsubtypeData.UpdatedAsset_CollateralValuationTolerance);
	    ...
	    public void update_the_value_in_remarks_field_of_collateral_sub_type() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeRemarksField().sendKeys(collateralsubtypeData.UpdatedRemarks);
	    }
	    ...
	    public void clear_the_value_in_required_fields_and_validate_the_field_required_popup() throws Throwable {
			...
			for (int i = 0; i < 50; i++) {
				try {
						driver.findElement(By.xpath("//ion-label[contains(text(),'" + collateralsubtypeData.validateAsset_CollateralType
								+ "')]/following-sibling::ion-radio")).click();
						break;
					} catch (Exception e) {
					}
	    ...
	    public void update_the_status_of_collateral_sub_type_record() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.statusToggleIconOfCollateralSubtype(),60,2);
	    ...
	    public void validat_the_export_to_pdf_functionality_of_collateral_sub_type() throws Throwable {
            ...
            seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.exportToPDFOfCollateralSubType(),60,3);
	    ...
	    public void validate_the_view_summary_of_collateral_sub_type() throws Throwable {
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.viewSummaryIconOfCollateralSubType(),60,2);
	    	
					seleniumactions.getJavascriptHelper().JSEClick(collateralsubtypeObj.viewSummaryIconOfCollateralSubType());
					
	    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,collateralsubtypeObj.viewSummaryPageOfCollateralSubType(),60,2);
	    ...
	    public void update_the_value_in_assetcollateralsubtypecode_field_for_checker_reject() throws Throwable {
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().clear();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.updatedAsset_CollateralSubtypeCodeForReject);
	    ...
	    public void update_the_value_in_assetcollateralsubtypecode_field_for_chcker_return() throws Throwable {
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().clear();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.updatedAsset_CollateralSubtypeCodeForReturn);
	    }
	    ...
	    public void update_the_value_in_assetcollateralsubtypecode_field_for_checker_approve() throws Throwable {
	    	...
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().click();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().clear();
	    	collateralsubtypeObj.CollateralSubTypeCollateralSubTypeCodeField().sendKeys(collateralsubtypeData.UpdatedAsset_CollateralSubtypeCodeForApprove);
	    ...
	    public void validate_the_record_in_mail_box_with_updated_record_for_checker_return() throws Throwable {
	    	for (int i = 0; i < 20; i++) {
	    	    try {
	    	        ...
	    	        String validate = driver.findElement(By.xpath("//ion-label[contains(text(),'Asset/Collateral subtype code')]//following-sibling::ion-input")).getAttribute("ng-reflect-model");
	    	        System.out.println(validate);
	    	        Assert.assertEquals(validate, collateralsubtypeData.updatedAsset_CollateralSubtypeCodeForReturn);
	    	        break;
	    	    }
	    	    catch(Exception e) {
	    	    	Assert.fail();
