...
public class ApplicationDetailsDisbursementChecker {
	...
	ExcelData excelData = new ExcelData("C:\\Users\\inindc00074\\Downloads\\UlsTestDataDesign0612e.xlsx","ADDCTestData","Data Set ID");
	...
	public void user_click_the_action_edit_icon_in_application_detail_disbursement_checker() throws Throwable {
		...
		Transaction.searchsentkeys().click();
    ...
    public void user_click_the_action_edit_icon_in_application_details_prerequest() throws Throwable {
		...
		help.waitForElementToVisibleWithFluentWait(driver, Transaction.searchsentkeys(), 60, 5);
		Transaction.searchsentkeys().sendKeys("NewApp");
    ...
    public void search_the_value_as_disbckr() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,Transaction.ApplicationDetailsInboxView_SearchText(),60,2);
    	Transaction.ApplicationDetailsInboxView_SearchText().click();
    	Transaction.ApplicationDetailsInboxView_SearchText().sendKeys(testData.get("Inbox Search"));
    }
