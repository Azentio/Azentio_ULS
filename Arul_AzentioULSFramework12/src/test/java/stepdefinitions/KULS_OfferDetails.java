...
import pageobjects.KULS_OfferDetailsObj;
...
public class KULS_OfferDetails {
	...
	KULS_OfferDetailsObj offerDetailsObj = new KULS_OfferDetailsObj(driver);
    ...
    public void enter_the_reference_id_of_the_Offer_Details_record() throws Throwable {
    	...
    	offerDetailsObj.offerDetails_SearchInboxInputField().sendKeys("offer");
    ...
    public void verify_all_the_fields_under_section_eligibility_details_should_be_in_read_only_mode() throws Throwable {
		try {
			offerDetailsObj.offerDetails_EligibilityTypeValue().sendKeys(testdata.get("Edit Text"));
		...
		try {
			offerDetailsObj.offerDetails_EligibilityAmountValue().sendKeys(testdata.get("Edit Text"));
		...
		try {
			offerDetailsObj.offerDetails_EligibilityPercentageValue().sendKeys(testdata.get("Edit Text"));
		...
		try {
			offerDetailsObj.offerDetails_CurrencyValue().sendKeys(testdata.get("Edit Text"));
		...
		try {
			offerDetailsObj.offerDetails_ActualPercentageValue().sendKeys(testdata.get("Edit Text"));
		...
		try {
			offerDetailsObj.offerDetails_DeviationLevelValue().sendKeys(testdata.get("Edit Text"));
...
//    	javaScriptHelper.scrollIntoView(offerDetailsObj.offerDetails_InterestRateStructure_PenaltyFee());
    ...
    public void verify_all_the_fields_under_section_interest_rate_structure_should_be_in_read_only_mode() throws Throwable {
    	try {
			offerDetailsObj.offerDetails_InterestRateStructure_IdValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_PeriodValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_RateDefinitionValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_InterestRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_IndexRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_BaseRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_SpreadRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_CapRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_FloorRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_RBPAdjusterValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_PenaltyRateValue().sendKeys(testdata.get("Edit Text"));
    	...
    	try {
    		offerDetailsObj.offerDetails_InterestRateStructure_PenaltyFeeValue().sendKeys(testdata.get("Edit Text"));
    ...
    public void verify_the_field_period_under_section_Installments_should_be_in_read_only_mode() throws Throwable {
    	try {
    		offerDetailsObj.offerDetails_InstallmentPeriodValue().sendKeys(testdata.get("Edit Text"));
    ...
    public void verify_the_field_installment_amount_should_be_non_editable() throws Throwable {
    	try {
    		offerDetailsObj.offerDetails_InstallmentAmountValue().sendKeys(testdata.get("Edit Text"));
    ...
    public void verify_new_requested_tenure_field_system_should_allow_user_to_enter_value_manually() throws Throwable {
    	try {
    		...
    		offerDetailsObj.offerDetails_NewRequestedTenure().sendKeys(testdata.get("New Requested Tenure"));
		} catch (Exception e) {
			// TODO: handle exception
    ...
    public void verify_new_requested_amount_field_system_should_allow_user_to_enter_value_manually() throws Throwable {
    	try {
    		waithelper.waitForElementwithFluentwait(driver, offerDetailsObj.offerDetails_NewRequestedTenure());
    		offerDetailsObj.offerDetails_NewRequestedAmount().sendKeys(testdata.get("New Requested Amount"));
		} catch (Exception e) {
			// TODO: handle exception
    ...
    public void update_test_data_for_offer_details_test_case_one() throws Throwable {
    	testdata=exceldata.getTestdata("AT-OLOD-001_D1");
    }

    @And("^update test data for offer details test case three$")
    public void update_test_data_for_offer_details_test_case_three() throws Throwable {
    	testdata=exceldata.getTestdata("AT-OLOD-003_D1");
    }

    @And("^update test data for offer details test case four$")
    public void update_test_data_for_offer_details_test_case_four() throws Throwable {
    	testdata=exceldata.getTestdata("AT-OLOD-004_D1");
    }

    @And("^update test data for offer details test case five$")
    public void update_test_data_for_offer_details_test_case_five() throws Throwable {
    	testdata=exceldata.getTestdata("AT-OLOD-005_D1");
    }

    @And("^update test data for offer details test case six$")
    public void update_test_data_for_offer_details_test_case_six() throws Throwable {
    	testdata=exceldata.getTestdata("AT-OLOD-006_D1");
    }
