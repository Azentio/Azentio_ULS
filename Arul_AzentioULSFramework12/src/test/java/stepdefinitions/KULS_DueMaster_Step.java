...
public class KULS_DueMaster_Step {
	...
	public void launch_the_kuls_application_and_navigate_to_due_master_module_view_list() throws Throwable {
	    ...
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.configurationInLeftPanel(),60,2);
	    ...
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterViewIcon(),60,2);
	    duemasterObj.dueMasterViewIcon().click();     
	}

	@Then("^Click on Save button$")
	public void click_on_save_button() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterSaveButton(),60,2);
	    duemasterObj.dueMasterSaveButton().click();
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMastersubmitSuccessPopup(),60,2);
	    Assert.assertEquals(duemasterObj.dueMastersubmitSuccessPopup().isDisplayed(), true); 
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.closeIconInSuccessPopup(),60,2);
	    duemasterObj.closeIconInSuccessPopup().click();
	}

	@And("^Click on Add icon$")
	public void click_on_add_icon() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterAddIcon(),60,2);
	...
	public void enter_the_value_in_due_code_field() throws Throwable {
		seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterDueCodeField(),60,2);
		duemasterObj.dueMasterDueCodeField().click();
		duemasterObj.dueMasterDueCodeField().sendKeys(dueMasterData.DueCode);        
	}

	@And("^Enter the value in Description field$")
	public void enter_the_value_in_description_field() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterDescriptionField(),60,2);
	    duemasterObj.dueMasterDescriptionField().click();
	    duemasterObj.dueMasterDescriptionField().sendKeys(dueMasterData.Description);
	}

	@And("^Select the value in Waiver allowed field$")
	public void select_the_value_in_waiver_allowed_field() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, duemasterObj.dueMasterWaiverAllowedField(), 60, 2);
	    duemasterObj.dueMasterWaiverAllowedField().click();
		for (int i = 0; i < 50; i++) {
			try {
					driver.findElement(By.xpath("//ion-label[contains(text(),'" + dueMasterData.WaiverAllowed
	...
	public void enter_the_value_in_legal_coed1_field() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterLegalCode1Field(),60,2);
	    duemasterObj.dueMasterLegalCode1Field().click();
	    for (int i = 0; i < 50; i++) {
				try {
	        duemasterObj.dueMasterLegalCode1Field().sendKeys(dueMasterData.LegalCode1);
	        break;
				} catch (Exception e) {
				}
	    	}	   
	...
	public void enter_the_value_in_legal_code2_field() throws Throwable {
	    seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterLegalCode2Field(),60,2);
	    duemasterObj.dueMasterLegalCode2Field().click();
	    duemasterObj.dueMasterLegalCode2Field().sendKeys(dueMasterData.LegalCode2);      
	}

	@And("^Enter the value in Legal code3 field$")
	public void enter_the_value_in_legal_coed3_field() throws Throwable {
	   	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterLegalCode3Field(),60,2);
	    duemasterObj.dueMasterLegalCode3Field().click();
	    duemasterObj.dueMasterLegalCode3Field().sendKeys(dueMasterData.LegalCode3);
	}

    @And("^Select the value in Repayment flag field$")
    public void select_the_value_in_repayment_tag_field() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, duemasterObj.dueMasterRepaymentFlagField(), 60, 2);
    	duemasterObj.dueMasterRepaymentFlagField().click();
		for (int i = 0; i < 50; i++) {
				try {
					driver.findElement(By.xpath("//ion-label[contains(text(),'" + dueMasterData.RepaymentFlag
							+ "')]/following-sibling::ion-radio")).click();
					break;
				} catch (Exception e) {
				}
    ...
    public void select_the_value_in_future_adjustment_flag_field() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, duemasterObj.dueMasterFutureAdjustmentFlagField(), 60, 2);
    	duemasterObj.dueMasterFutureAdjustmentFlagField().click();
		for (int i = 0; i < 50; i++) {
				try {
					driver.findElement(By.xpath("//ion-label[contains(text(),'" + dueMasterData.FutureAdjustmentFlag
							+ "')]/following-sibling::ion-radio")).click();
					break;
				} catch (Exception e) {
				}
    ...
    public void select_the_value_in_is_tax_due_field() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, duemasterObj.dueMasterIsTaxDueField(), 60, 2);
    	duemasterObj.dueMasterIsTaxDueField().click();
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'" + dueMasterData.IsTaxDue
							+ "')]/following-sibling::ion-radio")).click();
					break;
				} catch (Exception e) {
				}
    ...
    public void select_the_value_in_tax_calculation_method() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver, duemasterObj.dueMasterTaxCalculationMethodField(), 60, 2);
    	duemasterObj.dueMasterTaxCalculationMethodField().click();
		for (int i = 0; i < 50; i++) {
			try {
				driver.findElement(By.xpath("//ion-label[contains(text(),'" + dueMasterData.TaxCalculationMethod
							+ "')]/following-sibling::ion-radio")).click();
				break;
				} catch (Exception e) {
				}
    ...
    public void enter_the_value_in_remarks_field() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterRemarksField(),60,2);
    	duemasterObj.dueMasterRemarksField().click();
    	for (int i = 0; i < 50; i++) {
			try {
					duemasterObj.dueMasterRemarksField().sendKeys(dueMasterData.Remarks);
					break;
				} catch (Exception e) {
				}				
			}	        	        
    ...
    public void verify_that_required_fields_are_present_with_red_color_astric_symbol() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterRedColorAstricSymbolForRequiredField(),60,2);
	...
	public void click_on_save_button_without_entering_the_values_in_required_fields() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterSaveButton(),60,2);
        duemasterObj.dueMasterSaveButton().click();
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.requiredFieldWarningPopup(),60,2);
        Assert.assertEquals(duemasterObj.requiredFieldWarningPopup().isDisplayed(), true);
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterBackButton(),60,2);
    ...
    public void enter_the_invalid_value_in_due_code_field() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterDueCodeField(),60,2);
        duemasterObj.dueMasterDueCodeField().click();
        duemasterObj.dueMasterDueCodeField().sendKeys("#$#$");
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterDescriptionField(),60,2);
        duemasterObj.dueMasterDescriptionField().click();
        duemasterObj.dueMasterDescriptionField().sendKeys("#$#$");
        seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.alphaNumericCharactersAllowedWarningPopup(),60,2);
    ...
    public void navigate_to_temp_view_in_view_list() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.dueMasterTempView(),60,2);
    ...
    public void update_the_status_of_the_record() throws Throwable {
    	seleniumactions.getWaitHelper().waitForElementToVisibleWithFluentWait(driver,duemasterObj.statusToggleIcon(),60,2);
