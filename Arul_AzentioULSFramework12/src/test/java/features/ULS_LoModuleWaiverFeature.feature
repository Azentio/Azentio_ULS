...
And Update test data for Lo Module waiver test case one
...
And Update test data for Lo Module waiver test case two
...
Given Login into KULS for checker user
And login with checker credentials
And Update test data for Lo Module waiver test case three
And click on notificatrion in checker stage
And select the record by the help of reference ID 
...
Given Login into KULS for checker user
And login with checker credentials
And Update test data for Lo Module waiver test case four
And click on notificatrion in checker stage
And select the record by the help of reference ID 
...
Given Launch the kuls application
And click on config manager main menu
And Update test data for Lo Module waiver test case five
And click on temp view on LO Module waiver 
And click on add button to create LO Module waiver record
