...
//	@FindBy(xpath = "//ion-label[contains(text(),'Asset Collateral Config')]")
	...
	private WebElement assetCollateralType_MenuToggle;
	
	public WebElement assetCollateralType_MenuToggle() {
		return assetCollateralType_MenuToggle;
	}
...
//	@FindBy(xpath = "//h4[contains(text(),'Collateral type')]/ancestor::ion-label/following-sibling::ion-buttons/ion-button[1]")
	@FindBy(xpath = "//ion-label[contains(text(),'Colleteral type')]/following-sibling::ion-buttons/ion-button[1]")
...
//	@FindBy(xpath = "//h4[contains(text(),'Collateral type')]/ancestor::ion-label/following-sibling::ion-buttons/ion-button[2]")
	@FindBy(xpath = "//ion-label[contains(text(),'Colleteral type')]/following-sibling::ion-buttons/ion-button[2]")
...
//	@FindBy(xpath = "//button[@ng-reflect-text='Search']")
	@FindBy(xpath = "//div[3]/span[1]/button[1]")
	...
	private WebElement assetCollateralType_Maker_SearchInbox;

	public WebElement assetCollateralType_Maker_SearchInbox() {
		return assetCollateralType_Maker_SearchInbox;
	}

	// search inbox input fields
	@FindBy(xpath = "//p-table/div/div/div/span/input")
	private WebElement assetCollateralType_Maker_SearchInboxInputField;

	public WebElement assetCollateralType_Maker_SearchInboxInputField() {
		return assetCollateralType_Maker_SearchInboxInputField;
	}

	// SearchInboxCloseButton
	@FindBy(xpath = "//p-table/div/div/div/span/i")
	private WebElement assetCollateralType_Maker_SearchInboxCloseButton;

	public WebElement assetCollateralType_Maker_SearchInboxCloseButton() {
		return assetCollateralType_Maker_SearchInboxCloseButton;
	}
	...
	@FindBy(xpath = "//ion-label[contains(text(),' Description ')]/following::ion-input[1]")
	private WebElement assetCollateralType_DescriptionEditable;

	public WebElement assetCollateralType_DescriptionEditable() {
		return assetCollateralType_DescriptionEditable;
	}
	...
	@FindBy(xpath = "//ion-item[4]/ion-select")
...
//	}
	...
	// Asset/Collateral type code editable
	@FindBy(xpath = "//ion-label[contains(text(),' Asset/Collateral type code ')]/following::ion-input[1]")
	private WebElement assetCollateralType_AssetCollateralTypeCodeEditable;

	public WebElement assetCollateralType_AssetCollateralTypeCodeEditable() {
		return assetCollateralType_AssetCollateralTypeCodeEditable;
	}
	...
	// HairCut % editable
	@FindBy(xpath = "//ion-label[contains(text(),'  HairCut % ')]/following-sibling::ion-input")
	private WebElement assetCollateralType_HairCutPercentEditable;

	public WebElement assetCollateralType_HairCutPercentEditable() {
		return assetCollateralType_HairCutPercentEditable;
	}
	...
	// Remarks editable
	@FindBy(xpath = "//ion-label[contains(text(),' Remarks ')]/following-sibling::ion-textarea")
	private WebElement assetCollateralType_RemarksEditable;

	public WebElement assetCollateralType_RemarksEditable() {
		return assetCollateralType_RemarksEditable;
	}
...
//	@FindBy(xpath = "//ion-list[1]/ion-item[1]/div[1]")
	...
	private WebElement assetCollateralType_ModuleName;
	
	public WebElement assetCollateralType_ModuleName() {
		return assetCollateralType_ModuleName;
	}
