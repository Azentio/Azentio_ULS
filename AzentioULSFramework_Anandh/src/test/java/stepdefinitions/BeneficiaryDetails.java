...
public class BeneficiaryDetails extends BaseClass {
	...
	public void get_the_test_data_for_beneficiary_detials_creation() throws Throwable {

		beneficiaryDetailsTestData = excelDataforBeneficiaryDetials.getTestdata("AT-BD-001_D1");
	}
	@And("^get the test data for beneficiary Detials creation with valid data$")
    public void get_the_test_data_for_beneficiary_detials_creation_with_valid_data() throws Throwable {
		beneficiaryDetailsTestData = excelDataforBeneficiaryDetials.getTestdata("AT-BD-001_D2");
    }
	...
	public void enter_as_disbursement_maker_in_the_search_bar_in_beneficiary_detail() throws Throwable {
		...
		beneficiaryobj.SearchBar().sendKeys(beneficiaryDetailsTestData.get("Stage Code"));
	}
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath(
						"//ion-label[contains(text(),'" + beneficiaryDetailsTestData.get("Facility Appliation ID")
	...
	public void to_verify_the_field_beneficiary_name_in_beneficiary_details() throws Throwable {
		...
		beneficiaryobj.BeneficiaryName().sendKeys(beneficiaryDetailsTestData.get("Beneficiary Name"));
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Beneficiary Type") + "')]/following-sibling::ion-radio"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 60) {
	...
	public void to_verify_the_field_beneficiary_kyc_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 100; i++) {
			...
			try {
				...
				beneficiaryobj.beneficiaryKYC().sendKeys(beneficiaryDetailsTestData.get("Beneficiary KYC"));
				break;
			} catch (Exception e) {
				if (i == 100) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_beneficiary_address_in_beneficiary_details() throws Throwable {
		...
		beneficiaryobj.beneficiaryAddress().sendKeys(beneficiaryDetailsTestData.get("Beneficiary Address"));
	...
	public void to_verify_the_field_account_type_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Account Type") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_iban_account_number_in_beneficiary_details() throws Throwable {
		...
		double IBANAccountNumber = Double.valueOf(beneficiaryDetailsTestData.get("IBAN Account No"));
		String strIBANAccountNum = String.format("%.0f", IBANAccountNumber);

		System.out.println("IBAN Account number " + strIBANAccountNum);
		beneficiaryobj.IBANorAccountNo().sendKeys(strIBANAccountNum);
	...
	public void to_verify_the_field_micr_type_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("MICR Type") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_beneficiary_micr_code_in_beneficiary_details() throws Throwable {
		...
		System.out.println("MICR Code" + strbeneficiaryMICRCode);
		String micrCode = String.valueOf(strbeneficiaryMICRCode);
		for (int i = 0; i < 60; i++) {
			try {

				driver.findElement(By.xpath(
						"//ion-label[contains(text(),'" + strbeneficiaryMICRCode + "')]/following-sibling::ion-radio"))
						.click();
				break;
			} catch (Exception e) {
				if (i == 60) {
	...
	public void to_verify_the_field_bank_code_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Bank Code") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_branch_name_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Branch Name") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_ifsc_code_in_beneficiary_details() throws Throwable {
		...
		beneficiaryobj.IFSCCode().sendKeys(beneficiaryDetailsTestData.get("IFSC Code"));
	...
	public void to_verify_the_field_payment_type_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Payment Type") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_payment_mode_in_beneficiary_details() throws Throwable {
		...
		for (int i = 0; i < 60; i++) {
			try {
				...
				driver.findElement(By.xpath("//ion-label[contains(text(),'"
						+ beneficiaryDetailsTestData.get("Payment Mode") + "')]/following-sibling::ion-radio")).click();
				break;
			} catch (Exception e) {
				if (i == 60) {
					Assert.fail(e.getMessage());
	...
	public void to_verify_the_field_beneficiary_email_in_beneficiary_details() throws Throwable {
		...
		beneficiaryobj.beneficiaryEmail().sendKeys(beneficiaryDetailsTestData.get("Beneficiary eMail"));
	...
	public void to_verify_the_field_remark_in_beneficiary_details() throws Throwable {
		...
		mandateOrNot.verifyGivenFieldisMandatoryOrNot(beneficiaryDetailsTestData.get("Remarks"));
	...
	public void validate_the_save_popup_in_beneficiary_details() throws Throwable {
		...
		String saveSucessValidation = beneficiaryobj.successMgs().getText();
		Assert.assertTrue(saveSucessValidation.contains("Success"));
	...
	public void verify_the_impact_when_user_enters_only_special_characters_value_in_any_field_in_beneficiary_details()
			throws Throwable {
		waithelper.waitForElementToVisibleWithFluentWait(driver, beneficiaryobj.beneficiaryAddress(), 60, 2);
		beneficiaryobj.beneficiaryAddress().click();
		beneficiaryobj.beneficiaryAddress().sendKeys("*%%*");
		WebElement errorPopUp = driver
				.findElement(By.xpath("//ion-badge[contains(text(),' Alphanumeric characters allowed')]"));
	...
	public void verify_the_impact_when_user_enter_numeric_value_in_character_field_in_beneficiary_detail()
			throws Throwable {
		waithelper.waitForElementToVisibleWithFluentWait(driver, beneficiaryobj.BeneficiaryName(), 60, 2);
		beneficiaryobj.BeneficiaryName().click();
	...
	public void verify_the_impact_when_user_enter_characters_value_in_numeric_field_in_beneficiary_detail()
			throws Throwable {
		waithelper.waitForElementToVisibleWithFluentWait(driver, beneficiaryobj.IBANorAccountNo(), 60, 2);
		beneficiaryobj.IBANorAccountNo().click();
		beneficiaryobj.IBANorAccountNo().sendKeys("1234");
		beneficiaryobj.IBANorAccountNo().sendKeys("abcd");
		String IBANorAccountNo = beneficiaryobj.IBANorAccountNoText().getAttribute("ng-reflect-model");
