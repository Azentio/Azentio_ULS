...
#		And click on asset collateral config menu
  ...
  @ACT_T006/ACT_T007
  Scenario: Collateral Type Master - Modification of Asset Collateral type record and verify the functionality of approved button
  	Given User launch the kuls application
  	And User Login as maker
  	Then user should navigate to asset collateral config
  	And click on temp view button of asset collateral config
  ...
  #	--
  	...
  	@ACT_T006/ACT_T007
  Scenario: Collateral Type Master - Modification of Asset Collateral type record and reject approved button
