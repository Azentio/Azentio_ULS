...
public class PropertyDetails {
    ...
    public void enter_the_reference_id_of_the_property_details_record() throws Throwable {
    	...
    	propertyDetailsObj.propertyDetails_SearchInboxInputField().sendKeys(propertyDetailsTestDataType.ReferenceID);
    ...
    @Then("^open the record of Property Details to modify$")
    public void open_the_record_of_Property_Details_to_modify() throws Throwable {
    	...
    	propertyDetailsObj.propertyDetails_SearchInputField().sendKeys(propertyDetailsTestDataType.AssetID);
    	String beforexpath= "//span[contains(text(),'"; 
    	String afterxpath= "')]/../../../td[2]/span/button[1]";
    	waithelper.waitForElementwithFluentwait(driver, driver.findElement(By.xpath(beforexpath +propertyDetailsTestDataType.AssetID+ afterxpath)));
    	driver.findElement(By.xpath(beforexpath +propertyDetailsTestDataType.AssetID+ afterxpath)).click();
